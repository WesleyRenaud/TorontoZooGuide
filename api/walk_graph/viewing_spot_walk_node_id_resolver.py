...
from .enclosure_viewing_walk_node_lookup import EnclosureViewingWalkNodeLookup
...
class ViewingSpotWalkNodeIdResolver():
   ...
   def resolve(
      ...
      walk_node_id = EnclosureViewingWalkNodeLookup.walk_node_id_by_enclosure_name().get(
