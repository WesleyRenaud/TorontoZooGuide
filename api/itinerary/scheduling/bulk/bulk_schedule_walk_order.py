...
def representative_walk_node_id(
   ...
   return _representative_walk_node_id_from_distances(
      distances,
      viewing_node_ids )
...
def sort_animals_for_bulk_schedule(
   ...
   while remaining_animals:
      ...
      next_node_id = _representative_walk_node_id_from_distances(
         distances,
         viewing_node_ids_by_animal[
...
def _representative_walk_node_id_from_distances(
      distances: dict[ str, float ],
      viewing_node_ids: tuple[ str, ... ] ) -> str | None:
