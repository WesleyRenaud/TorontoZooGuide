...
class TransportationTransitRideApplier():
   ...
   def apply(
      ...
      for transit_row in transit_rows:
         ...
         station_walk_nodes = cls._station_walk_node_ids(
            conn,
            transportation=transit_row.transportation,
            day_loop=day_loop,
         ...
         animal_anchors = cls._animal_anchors(
            walk_graph,
            entrance_node_id,
            scheduled_animals )
         ...
         timeline_start_seconds, start_node_id = cls._transit_timeline_start(
         ...
         rides_before_animals, return_ride = cls._plan_rides_for_anchors(
            day_loop=day_loop,
            station_walk_nodes=station_walk_nodes,
   ...
   def _plan_rides_for_anchors(
      ...
      return_ride = cls._best_saving_ride(
         day_loop=day_loop,
         station_walk_nodes=station_walk_nodes,
         from_node_id=current_node_id,
   ...
   def _apply_timeline(
      ...
      for ride, anchor in zip( rides_before_animals, animal_anchors ):
         ...
         if ride is not None:
            ...
            proposed_ride_start = (
               cursor_seconds
               + cls._walk_seconds_to_station(
                  walk_graph=walk_graph,
                  adjacency=adjacency,
                  station_walk_nodes=station_walk_nodes,
                  from_node_id=current_node_id,
                  station_name=ride.from_station ) )
            ride_window = cls._ride_window_within_operating_hours(
               proposed_ride_start,
               ride_duration,
               operating_hours )
      ...
      if return_ride is not None:
         ...
         return_window = cls._ride_window_within_operating_hours(
            proposed_return_start,
