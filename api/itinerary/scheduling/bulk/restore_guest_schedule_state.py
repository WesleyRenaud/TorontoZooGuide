...
def snapshot_guest_schedule_state(
   ...
   return ( saved_itinerary, ItineraryWalkRouteProvider.fetch_itinerary_walk_route( conn ) )
...
def restore_guest_schedule_state(
   ...
   ItineraryTimeProvider.set_itinerary_arrival_time( conn, saved_itinerary.arrival_time )
   ItineraryTimeProvider.set_itinerary_departure_time( conn, saved_itinerary.departure_time )
