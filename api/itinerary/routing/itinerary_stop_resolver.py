...
class ItineraryStopResolver():
   ...
   @classmethod
   def resolve( cls, itinerary: Itinerary ) -> list[ ItineraryStop ]:
      ...
      for animal in itinerary.animals:
         ...
         stops.append(
            ItineraryStop(
               ...
               is_fixed_time=cls._has_schedule_times(
                  animal.start_time,
                  animal.end_time ),
   ...
   @classmethod
   def resolve_fixed_time( cls, itinerary: Itinerary ) -> list[ ItineraryStop ]:
      return [
         stop
         for stop in cls.resolve( itinerary )
   ...
   def _stop_from_map_location(
      ...
      return ItineraryStop(
         ...
         x_coord=x_coord,
         y_coord=y_coord,
         is_fixed_time=cls._has_schedule_times( start_time, end_time ),
