...
def order_itinerary_stops_for_walk_route(
      stops: list[ ItineraryStop ] ) -> list[ ItineraryStop ]:
   entrance_stop = next(
      (
         stop
         for stop in stops
   ...
   scheduled_stops.sort( key=_walk_route_stop_sort_key )
...
def _walk_route_stop_sort_key( stop: ItineraryStop ) -> tuple[ int, str, str ]:
