...
class ItineraryTransportationMapper():
   @classmethod
   ...
   def map_record(
      ...
      return ItineraryTransportationRecord(
         ...
         route_marker_sequences=ItineraryTransportationRouteMarkerMapper.route_marker_sequences_for_markers( route_markers ),
      )
   ...
   def map_records(
      ...
      for leg in legs:
         key = cls.transportation_row_key(
            leg.transportation,
