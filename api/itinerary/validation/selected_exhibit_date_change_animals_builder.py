...
class SelectedExhibitDateChangeAnimalsBuilder():
   ...
   def apply_on_date_change(
      ...
      old_likelihoods = cls._likelihoods_by_viewing_spot_for_exhibits(
         animal_coordinator,
      ...
      expand_old_likelihoods = cls._likelihoods_by_viewing_spot_for_exhibits(
         animal_coordinator,
         selected_exhibits=selected,
         visit_date=old_visit_date,
         visit_date_temp=visit_date_temp )

      for animal in cls._viewable_animals_for_exhibits(
            animal_coordinator,
            selected_exhibits=selected,
