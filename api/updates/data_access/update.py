...
def insert_update( conn: Connection, update: Update ) -> bool:
   cur = conn.cursor()
...
def update_end_date( conn: Connection, update: Update ) -> bool:
   cur = conn.cursor()
...
def edit_update_record( conn: Connection, update: Update ) -> bool:
   cur = conn.cursor()
