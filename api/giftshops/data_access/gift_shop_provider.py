...
from .gift_shop_mapper import GiftShopMapper
...
class GiftShopProvider():
   ...
   def fetch_gift_shop_records(
      ...
      try:
         ...
         return GiftShopMapper.map_records( data.fetchall() )
   ...
   def fetch_gift_shop_schedule_records(
      ...
      try:
         ...
         return GiftShopScheduleMapper.map_records( data.fetchall() )
   ...
   def fetch_gift_shop_schedule_override_records(
      ...
      try:
         ...
         return GiftShopScheduleOverrideMapper.map_records( data.fetchall() )
