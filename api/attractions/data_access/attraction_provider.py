...
from .attraction_mapper import AttractionMapper
...
class AttractionProvider():
   ...
   def fetch_attraction_records(
      ...
      try:
         ...
         return AttractionMapper.map_records( data.fetchall() )
   ...
   def fetch_attraction_record_for_calendar_day(
      ...
      try:
         ...
         return AttractionMapper.map_record( row ) if row != None else None
   ...
   def fetch_attraction_schedule_override_records(
      ...
      try:
         ...
         return AttractionScheduleOverrideMapper.map_records( data.fetchall() )
