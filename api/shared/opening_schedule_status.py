...
def resolve_amenity_likelihood_and_message(
   ...
   override_status, override_message = get_active_schedule_override_status(
   ...
   schedule_status, schedule_message = get_active_opening_schedule_status(
   ...
   if schedule_status == ScheduleStatus.CLOSED:
      ...
      likelihood = calculate_seasonal_likelihood( seasonal_multiplier )
