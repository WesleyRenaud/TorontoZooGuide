import { setAttractionClosureOverride } from '../../../api/consoleOperationsApi.js';
...
export function createAttractionClosureOverrideController({
   attractionEl,
   ...controllerOptions
} = {}) {
