export class ConsoleOperationRefsCollector {
   ...
   static CONSOLE_OPERATION_REF_CONFIG = {
      animals: {
         offDisplay: {
   ...
   static createWeekdayScheduleRefs(doc, operationName) {
      return ConsoleOperationRefsCollector.createPrefixedRefs(doc, operationName, ConsoleOperationRefsCollector.WEEKDAY_FIELD_SUFFIXES);
   }
   ...
   static createWeeklyAvailabilityRefs(doc, operationName) {
      return ConsoleOperationRefsCollector.createPrefixedRefs(doc, operationName, {
         ...
         startDateEl: 'StartDate',
         endDateEl: 'EndDate',
         ...ConsoleOperationRefsCollector.WEEKDAY_FIELD_SUFFIXES,
   ...
   static collectConsoleOperationRefs(doc = document) {
      ...
      Object.entries(ConsoleOperationRefsCollector.CONSOLE_OPERATION_REF_CONFIG).forEach(([key, groupConfig]) => {
