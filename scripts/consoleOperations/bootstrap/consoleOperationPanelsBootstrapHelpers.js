...
export class ConsoleOperationPanelsBootstrapHelpers {
   ...
   static getPanelCreators() {
      return Object.values(ConsoleOperationPanelsBootstrapHelpers.PANEL_CREATORS).flat();
   }

   static createConsoleOperationPanelsFragment(doc = document) {
      const fragment = doc.createDocumentFragment();

      ConsoleOperationPanelsBootstrapHelpers.getPanelCreators().forEach((createPanel) => {
