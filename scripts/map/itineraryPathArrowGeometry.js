...
export class ItineraryPathArrowGeometry {
   ...
   static appendCubicBezierSamples(
      ...
      for (let step = 1; step <= steps; step += 1) {
         polyline.push(
            ItineraryPathArrowGeometry.cubicBezierPoint(step / steps, start, controlPoint1, controlPoint2, end)
         );
      }
   }
   ...
   static buildPathArrowPlacementsForPolyline(polyline, {
      ...
      const totalLength = ItineraryPathArrowGeometry.polylineLength(polyline);
      ...
      for (
         ...
         const placement = ItineraryPathArrowGeometry.pointAndTangentAtDistance(polyline, distance);
