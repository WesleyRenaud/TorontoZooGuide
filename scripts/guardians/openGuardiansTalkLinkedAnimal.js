...
export function getGuardiansTalkLinkedAnimal(talk = {}) {
   return NormalizeGuardiansTalkLinkedAnimals.normalizeGuardiansTalkLinkedAnimals(talk.linked_animals)[0] ?? null;
}

export async function openGuardiansTalkLinkedAnimal(talk) {
   const linkedAnimals = NormalizeGuardiansTalkLinkedAnimals.normalizeGuardiansTalkLinkedAnimals(talk.linked_animals);
