...
import { SelectionStore } from './base/selectionStore.js';
import { SelectorControllerConfig } from './selectorControllerConfig.js';
import { SelectorControllerView } from './selectorControllerView.js';
import { SelectorSearchRunner } from './selectorSearchRunner.js';
import { Strings } from '../../strings.js';

export class SelectorControllerFactory {
   ...
   deps = {},
      ...
      const {
         buildElements = SelectorControllerView.createSelectorElements,
      ...
      const selectionState = SelectionStore.createSelectorSelectionState({
         storageKey,
         migrateSelected,
         getId,
         makeSelection,
