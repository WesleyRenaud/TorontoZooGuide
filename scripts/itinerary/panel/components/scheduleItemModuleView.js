...
export class ScheduleItemModuleView {
   ...
   static buildScheduleItemModuleBody(strings, eventTypes = []) {
      const body = ItineraryPanelHelper.el('div', 'schedule-item-module-body');
      ...
      const searchField = ItineraryPanelHelper.el('div', 'schedule-item-field schedule-item-search-field');
      ...
      const resultsEl = ItineraryPanelHelper.el('div', 'itin-results schedule-item-results');
