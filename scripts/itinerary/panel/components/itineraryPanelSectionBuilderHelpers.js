export class ItineraryPanelSectionBuilderHelpers {
   ...
   static updateSectionBodyHeight(body, bodyInner) {
      ...
      if (items.length <= ItineraryPanelSectionBuilderHelpers.MAX_VISIBLE_ITEMS) {
         body.style.maxHeight = 'none';
         body.style.overflowY = 'hidden';
         body.style.overflowX = 'hidden';
         return;
      ...
      const visibleItems = items.slice(0, ItineraryPanelSectionBuilderHelpers.MAX_VISIBLE_ITEMS);
