import { ConfirmFragment } from './confirmFragment.js';
import { ItineraryPanelHelper } from '../itineraryPanelHelper.js';
import { Strings } from '../../../strings.js';

export class ActionsView {
   static makeActionsBar({ onAfterClear } = {}) {
      const actionsWrap = ItineraryPanelHelper.el('div', 'itin-panel-actions-wrap');

      const editBtn = ItineraryPanelHelper.el(
         'button',
         'itin-panel-edit-btn',
      ...
      const clearBtn = ItineraryPanelHelper.el('button', 'itin-panel-clear-btn', Strings.itinerary.actions.clear);
