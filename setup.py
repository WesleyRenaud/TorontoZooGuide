...
animals = [
   ...
   (
      ...
      '''The black tree monitor at the zoo shares an enclosure with the red-bellied short-necked turtles. Once you exit the aviary, this
         will be the enclosure directly to the left. The monitor tends to hide towards the back of the enclosure, often on top of one of
         the tree branches.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The black tree monitor (Varanus beccarii) is a slender, medium-sized monitor lizard distinguished by its glossy jet-black
         colouration. It has a long neck, narrow head, and an exceptionally long tail used for balance while climbing. Unlike many other
         monitor species, it lacks visible patterning, giving it a sleek, uniform appearance. As a member of the monitor lizard family
      ...
      '''In the wild, black tree monitors are opportunistic carnivores that feed primarily on insects, spiders, small birds, bird eggs,
         and small mammals. They are active hunters, using their keen eyesight and agility to locate prey among branches and foliage.
         At the zoo, their diet typically includes insects, small vertebrates, and nutritionally balanced prey items appropriate for
         monitor lizards.'''.replace( '\n', ' ' ),
      ...
      '''This species is exceptionally well adapted for life in the trees. Its long claws and powerful limbs allow it to climb vertical
         surfaces with ease, while its long tail provides balance during rapid movement through branches. The dark colouration may help
         with camouflage in shaded forest canopies and also aids in absorbing heat during basking.'''.replace( '\n', ' ' ),
      '''Female black tree monitors lay clutches of eggs, typically depositing them in protected locations such as hollow logs or
         burrows. After an incubation period, hatchlings emerge fully independent and capable climbers. Like many reptiles, growth is
         gradual, and individuals may live for several decades under human care.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The brownbanded bamboo shark is part of the main tank in the Great Barrier Reef exhibit. This animal is difficult to spot, as
         it likes to hide amongst the colour, specifically near the bottom of the tank.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The brownbanded bamboo shark (Chiloscyllium punctatum) is a small, slender shark recognized by the dark brown bands that cross
         its body when young. As it matures, these bands fade into scattered spots. It has a rounded snout, small eyes, and two dorsal
         fins set far back on the body. This species belongs to the bamboo shark family (Hemiscylliidae), a group of bottom-dwelling
         sharks adapted for life on coral reefs.'''.replace( '\n', ' ' ),
      '''Brownbanded bamboo sharks are found in the warm, shallow waters of the Indo-Pacific region, including coastal areas of
         Southeast Asia and northern Australia. They inhabit coral reefs, sandy bottoms, and seagrass beds, often resting in crevices
         or under ledges during the day. These sharks prefer calm, shallow environments where they can easily forage along the sea
         floor.'''.replace( '\n', ' ' ),
      ...
      '''This species is slow-moving and generally non-aggressive. Brownbanded bamboo sharks are mostly nocturnal and spend much of the
         day resting on the bottom. They are often tolerant of other animals and may be seen sharing space with other bottom-dwelling
         fish. Their calm nature makes them well suited to aquarium life.'''.replace( '\n', ' ' ),
      '''Unlike many sharks that must swim continuously to breathe, brownbanded bamboo sharks can actively pump water over their gills
         while resting. Their flexible bodies and strong fins allow them to maneuver through tight spaces in reef environments. As
         juveniles, their bold banding provides camouflage among coral shadows, helping protect them from predators.'''
         .replace( '\n', ' ' ),
      '''Brownbanded bamboo sharks reproduce by laying eggs, which are enclosed in tough, rectangular egg cases often called “mermaid’s
         purses.” Females attach these egg cases to rocks or coral. After several months, the young sharks hatch and are fully
         independent, resembling miniature versions of the adults.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      '''The brush-tailed bettong lives in the small aviary the kookaburras call home in the winter, just past the cockatoos and to
         the left. The brush-tailed bettong spends most of its time underground, but occasionally comes up, so be sure to check around
         the floor of the enclosure, specifically around any potential burrows. Brush-tailed bettongs are most active at evening, and
         during the night, so your best chance to see them is to visit the Australasia pavilion at the end of you day,'''
         .replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The brush-tailed bettong (Bettongia penicillata), also known as the woylie, is a small marsupial with soft grey-brown fur, a
         pointed snout, and large, upright ears. Its most distinctive feature is its long, bushy tail with a dark tip, which it uses
         for balance and to carry nesting material. It belongs to the kangaroo and wallaby family (Macropodidae).'''
         .replace( '\n', ' ' ),
      ...
      '''This species feeds primarily on underground fungi, tubers, roots, seeds, and other plant material. Brush-tailed bettongs play
         an important ecological role by digging for food, which helps aerate the soil and disperse fungal spores. At the zoo, they
         receive a diet that mimics their natural feeding habits, including vegetables, fruits, and specially prepared supplements.'''
         .replace( '\n', ' ' ),
      '''Brush-tailed bettongs are nocturnal and spend the daytime resting in shallow nests made from grass and leaf litter. They are
         generally solitary but may share overlapping home ranges. At night, they emerge to forage, using their keen sense of smell to
         locate food beneath the soil.'''.replace( '\n', ' ' ),
      ...
      '''Like other marsupials, brush-tailed bettongs give birth to very underdeveloped young. The tiny joey continues to grow in the
         mother’s pouch for several months before emerging. Females can reproduce year-round under suitable conditions, which helps
         populations recover when threats are controlled.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''In the wild, clown triggerfish feed on hard-shelled invertebrates such as sea urchins, crustaceans, mollusks, and occasionally
         small fish. Their powerful jaws and specialized teeth allow them to crush shells that many other fish cannot. At the zoo or
         aquarium, they are offered a varied diet of seafood items designed to promote natural feeding behaviours and dental health.'''
         .replace( '\n', ' ' ),
      '''Clown triggerfish are generally solitary and highly territorial, especially as adults. They are intelligent and curious fish,
         often recognizing keepers and actively investigating their surroundings. While visually appealing, they can be aggressive
         toward tank mates and are usually housed alone or with carefully selected species.'''.replace( '\n', ' ' ),
      ...
      '''Clown triggerfish reproduce by laying eggs on sandy or rocky substrates near reefs. The eggs are guarded aggressively, often
         by the female, until they hatch. The larvae drift in open water before settling onto reefs as they mature, gradually
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The crested pigeon is a medium-sized pigeon distinguished by the tall, slender crest of feathers on the top of its head. Its
         plumage is soft grey with pinkish tones on the chest, darker wings, and a distinctive black wing stripe bordered by iridescent
         green or purple patches. When startled into flight, the wings produce a sharp whistling sound caused by modified feathers. The
         species belongs to the pigeon and dove family (Columbidae).'''.replace( '\n', ' ' ),
      ...
      '''Crested pigeons are social birds that are commonly seen in pairs or small flocks. They are generally calm and tolerant of
         other species. The distinctive whistling sound produced during takeoff acts as a warning signal to other pigeons when danger
         is nearby. They spend much of their time walking on the ground and fly only when necessary.'''.replace( '\n', ' ' ),
      ...
      '''Crested pigeons form monogamous pairs and build simple stick nests in trees or shrubs. The female typically lays two eggs,
         which are incubated by both parents. Chicks grow quickly and are fed “pigeon milk,” a nutrient-rich secretion produced by the
         parents, before transitioning to solid food.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Crimson Rosella',
      ...
      '''The crimson rosella is a brightly coloured parrot known for its vivid red plumage, deep blue wings and tail, and black
         ...
         develop their red colouring as they mature. The species belongs to the parrot family (Psittaculidae) and is easily recognized
         by both its colouration and strong, curved beak.'''.replace( '\n', ' ' ),
      '''Crimson rosellas are native to eastern and southeastern Australia, including forested regions, woodlands, and coastal
         ...
         available.'''.replace( '\n', ' ' ),
      '''Their diet consists mainly of seeds, fruits, berries, nuts, blossoms, and insects. Crimson rosellas forage both in trees and
         on the ground. At the zoo, they are offered a varied diet that includes seeds, fresh fruits, vegetables, and formulated
      ...
      '''Strong beaks allow crimson rosellas to crack seeds and nuts efficiently, while their zygodactyl feet (two toes facing forward
         and two backward) provide excellent grip for climbing and handling food. Their bright plumage plays a role in communication
         and mate selection within forested environments.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The demoiselle cranes can be found in the outdoor aviary at the entrance to the Australasia Pavilion. The demoiselle cranes
         are generally more active earlier in the day, when they can often be seen wandering around their habitat, foraging for food.
         The cranes have no indoor public viewing.'''.replace( '\n', ' ' ),
      ...
      '''The demoiselle crane is a medium-sized crane distinguished by its slender body, long legs, and striking gray plumage. Adults
         have a white face stripe running from the eye down the neck, a black neck, and long, delicate white feathers trailing from
         the back of the head, giving it a “veil-like” appearance. The species belongs to the crane family (Gruidae) and is named for
         its elegant, graceful appearance reminiscent of a young lady.'''.replace( '\n', ' ' ),
      ...
      '''They are omnivorous, feeding primarily on seeds, grains, insects, small vertebrates, and plant material. Demoiselle cranes
         forage by walking slowly through grasslands, pecking at the ground, and probing for insects or other small prey. In captivity,
         their diet is supplemented with grains, vegetables, and formulated pellets to mimic their natural intake.'''
         .replace( '\n', ' ' ),
      '''Demoiselle cranes are highly social and often form pairs or small family groups outside of migration. They are known for their
         elaborate courtship dances, which include bowing, jumping, and wing-flapping displays. These cranes are generally quiet when
         foraging but produce loud trumpeting calls during flight and when communicating with conspecifics.'''.replace( '\n', ' ' ),
      '''Long legs and toes allow efficient movement across grasslands and shallow water, while strong wings support long migratory
         flights. Their elongated neck and sharp beak assist in foraging and social displays. The trailing white feathers on the head
         are thought to enhance visual signals during mating rituals.'''.replace( '\n', ' ' ),
      '''Breeding occurs in spring and summer. Pairs nest on the ground in shallow scrapes lined with grass. Typically, two eggs are
         laid and both parents share incubation duties. Chicks are precocial, leaving the nest shortly after hatching and following
         their parents to learn foraging and survival behaviours.'''.replace( '\n', ' ' ),                              
   ...
   (
      ...
      '''The Eastern Rosella is a medium-sized parrot with vibrant plumage. Its head is bright red, the back and wings are green and
         yellow, and the belly is white with scalloped black markings. The species has a short, strong beak and a long, tapered tail.
         Belonging to the parrot family (Psittaculidae), it is easily recognized by its striking mix of colours and lively presence.'''
         .replace( '\n', ' ' ),
      '''Eastern Rosellas are native to southeastern Australia, Tasmania, and nearby islands. They inhabit open forests, woodlands,
         ...
         .replace( '\n', ' ' ),
      '''These birds are primarily granivorous, feeding on seeds, fruits, berries, flowers, and occasionally insects. They forage both
         on the ground and in low vegetation. At the zoo, their diet includes a mix of seeds, fresh fruits, vegetables, and
         nutritionally balanced pellets, often scattered to encourage natural foraging behaviour.'''.replace( '\n', ' ' ),
      '''Eastern Rosellas are social but less gregarious than some other parrots, often seen in pairs or small groups. They are active
         and curious, frequently moving between perches and feeding areas. They are generally non-aggressive and interact calmly with
         other compatible species in mixed aviaries.'''.replace( '\n', ' ' ),
      '''Strong, curved beaks allow them to efficiently crack seeds and manipulate objects. Their bright plumage aids in communication
         and mate selection, while agile feet help them perch, climb, and forage in trees and shrubs. They are well adapted to open
         forest and grassland habitats with moderate temperature variation.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The emerald tree boa is a striking, non-venomous snake known for its bright green dorsal colouring and white zigzag markings
         along its back. Adults typically reach 1.2–2 metres in length. Its triangular head and heat-sensing pits along the upper lip
         help detect prey. The species belongs to the boa family (Boidae) and is famous for its arboreal lifestyle and coiled resting
         posture on branches.'''.replace( '\n', ' ' ),
      '''Emerald tree boas are native to the tropical rainforests of northern South America, including Brazil, Colombia, and Venezuela.
         They spend most of their lives in the forest canopy, preferring humid, shaded environments near rivers and streams.'''
         .replace( '\n', ' ' ),
      '''In the wild, emerald tree boas feed on small mammals, birds, and occasionally reptiles. They are ambush predators, waiting
         coiled on branches until prey comes within striking distance. At the zoo, their diet consists of appropriately sized rodents
         and birds, offered to mimic natural hunting behaviour.'''.replace( '\n', ' ' ),
      '''Emerald tree boas are largely solitary and highly territorial. They are mostly nocturnal, becoming active at night to hunt.
         During the day, they remain coiled on branches, using their cryptic colouring to blend in with the foliage. They are generally
         non-aggressive unless provoked.'''.replace( '\n', ' ' ),
      '''These snakes are perfectly adapted for life in the trees. Prehensile tails allow them to maintain a secure grip on branches,
         while their muscular bodies enable them to coil tightly and strike accurately. Heat-sensing pits help locate warm-blooded prey
         even in low-light conditions, and their green colouration provides camouflage among leaves.'''.replace( '\n', ' ' ),
      '''Emerald tree boas are ovoviviparous, meaning females give birth to live young rather than laying eggs. Litters typically
         contain 10–30 neonates. Juveniles are yellow or orange at birth, gradually developing the bright green adult colouration over
         several months.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Fly River Turtle',
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The Fly River turtles live in the pond in the main aviary. You can spot them by taking a right once you pass the aviary, and
         looking into the underwater viewing area.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The Fly River turtle, also known as the pig-nosed turtle, is a freshwater turtle notable for its soft, leathery shell and
         ...
         The species belongs to the family Carettochelyidae and is the only freshwater turtle with fully webbed flippers, giving it a
         unique appearance among turtles.'''.replace( '\n', ' ' ),
      ...
      '''In the wild, Fly River turtles are omnivorous, feeding on aquatic plants, fruits, and invertebrates. They use their flexible,
         flippered limbs to forage along the bottom of rivers and creeks. At the zoo, their diet includes a mix of leafy greens,
         aquatic vegetation, and small protein sources such as insects or fish to replicate natural foraging behaviour.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Galah, also known as the rose-breasted cockatoo, is a medium-sized parrot distinguished by its pink face and chest, grey
         back, wings, and tail, and a short, curved beak. Both males and females look similar, though subtle differences in eye colour
         can indicate sex. Galahs belong to the cockatoo family (Cacatuidae) and are easily recognised by their soft pink-and-grey
         plumage and crest.'''.replace( '\n', ' ' ),
      ...
      '''Their diet consists mainly of seeds, fruits, nuts, and vegetation. Galahs forage on the ground or in low trees and shrubs. In
         captivity, they are provided with a mix of seeds, fruits, vegetables, and formulated pellets to ensure balanced nutrition and
         encourage natural foraging behaviour.'''.replace( '\n', ' ' ),
      '''Galahs are social and highly gregarious, often forming flocks of dozens or hundreds. They are intelligent and playful,
         frequently engaging in acrobatic behaviours such as hanging upside down or swinging from branches. Vocal and interactive, they
         communicate with a range of calls and whistles, and pairs often form lifelong bonds.'''.replace( '\n', ' ' ),
      ...
      '''Breeding usually occurs in spring and summer. Pairs nest in tree hollows, where the female lays 2–5 eggs. Both parents take
         part in incubation and feeding of the chicks. Juveniles fledge after several weeks but may remain with the parents for a short
         period before joining larger flocks.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The green tree python is a slender, arboreal snake known for its brilliant green colouration, sometimes with blue or yellow
         accents depending on the individual and age. Juveniles are often yellow, red, or orange before changing to the vivid green of
         adults. The species has a triangular head, prehensile tail, and large eyes adapted for low-light hunting. It belongs to the
         python family (Pythonidae).'''.replace( '\n', ' ' ),
      '''Green tree pythons are native to the rainforests of New Guinea, parts of Indonesia, and northern Australia. They inhabit
         humid tropical forests, often resting coiled on branches high above the forest floor. Dense foliage provides camouflage and
         protection from predators.'''.replace( '\n', ' ' ),
      '''In the wild, green tree pythons feed primarily on small mammals, birds, and occasionally reptiles. They are ambush predators,
         remaining coiled on branches and striking quickly when prey passes nearby. At the zoo, their diet consists of appropriately
         sized rodents or birds, offered in a way that encourages natural hunting behaviour.'''.replace( '\n', ' ' ),
      '''Green tree pythons are solitary and highly territorial. They are mostly nocturnal hunters and spend much of the day resting
         coiled around branches. Their arboreal lifestyle makes them slow to move but extremely effective in ambushing prey. They are
         generally non-aggressive unless handled or provoked.'''.replace( '\n', ' ' ),
      '''Their prehensile tails allow them to maintain balance and grip on branches while hunting. Heat-sensing pits along their upper
         lips detect warm-blooded prey even in low-light conditions. Cryptic green colouring provides excellent camouflage in dense
         foliage, while their muscular bodies enable powerful, precise strikes.'''.replace( '\n', ' ' ),
      '''Green tree pythons are oviparous, laying clutches of 6–30 eggs in concealed locations. Females coil around the eggs to provide
         protection and regulate temperature until hatching. Juveniles are independent from birth and undergo dramatic colour changes
         as they mature.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Green-Winged Dove',
      ...
      '''The Green-winged Dove is a small, plump pigeon with a soft grey-brown body, a slightly iridescent green sheen on its wings,
         and a pale pinkish chest. It has a short, slender beak and red eyes with a subtle ring around them. The species belongs to the
         pigeon and dove family (Columbidae) and is easily recognised by its delicate colouring and gentle posture.'''
         .replace( '\n', ' ' ),
      ...
      '''These doves feed primarily on seeds, grains, fruits, and occasionally small insects. They forage on the ground or in low
         vegetation. In captivity, their diet includes a mix of seeds, grains, and small fruits, designed to reflect natural feeding
         behaviour.'''.replace( '\n', ' ' ),
      '''Green-winged Doves are social birds, often seen in pairs or small groups. They are generally calm and non-aggressive, moving
         quietly and foraging steadily. During courtship, males perform gentle displays and soft cooing calls to attract mates.'''
         .replace( '\n', ' ' ),
      '''Their compact bodies and strong wings allow efficient short-distance flight and manoeuvring through dense foliage. Subtle
         ...
         .replace( '\n', ' ' ),
      '''Breeding occurs year-round in favourable conditions. Nests are small platforms of twigs and leaves, often built in shrubs or 
         low trees. Typically, the female lays 1–2 eggs, incubated by both parents. Chicks are altricial, dependent on parental care
         until fledging.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Komodo Dragon',
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The Komodo dragons can we found in the center habitat in the main area of the pavilion past the aviary. The Komodo dragons at
         the zoo are young, and still getting used to their habitat. Most of the time you can find them high in the tree in the center
         of the enclosure. Look closely for a claw, or a dangling tail.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The Komodo dragon is the largest living lizard in the world, growing up to 3 metres in length and weighing up to 70 kilograms.
         It has a robust body covered in rough, scaly skin ranging from grey to reddish-brown, a broad head with powerful jaws, and a
         long, muscular tail. Its forked tongue and keen sense of smell aid in detecting prey over long distances. This species belongs
         to the monitor lizard family (Varanidae) and is instantly recognisable for its size and imposing presence.'''
         .replace( '\n', ' ' ),
      '''Komodo dragons are native to a few Indonesian islands, including Komodo, Rinca, Flores, and Gili Motang. They inhabit tropical
         savannahs, dry forests, and scrublands, often seeking shelter in burrows or under shade during the heat of the day.'''
         .replace( '\n', ' ' ),
      '''Komodo dragons are apex predators and opportunistic scavengers. Their diet includes deer, pigs, smaller reptiles, birds, eggs,
         and carrion. They use their sharp teeth, powerful bite, and bacteria-laden saliva to subdue prey. In captivity, their diet is
         carefully managed and includes a mix of meat, whole prey items, and enrichment to encourage natural hunting behaviours.'''
         .replace( '\n', ' ' ),
      ...
      '''Komodo dragons have evolved powerful limbs, strong jaws, and serrated teeth to take down large prey. Their forked tongues
         allow them to “smell” airborne chemicals, detecting carcasses up to 10 km away. Thick, armored skin provides protection from
         injury during fights and hunts. Their slow metabolism enables them to survive on infrequent, large meals.'''
         .replace( '\n', ' ' ),
      '''Komodo dragons reproduce sexually, and females can also reproduce via facultative parthenogenesis. Clutch sizes range from
         15–30 eggs, incubated for approximately 8 months in burrows or under vegetation. Hatchlings are highly vulnerable and spend
         their early years in trees to avoid predation. Adults reach sexual maturity around 8–9 years of age. In captivity, Komodo
         dragons live up to 30 years, while in the wild, typical lifespans are 25–30 years.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The kookaburras can either be found in the outdoor aviary with the demoiselle cranes, or inside in the small aviary just past
         and to the right of the cockatoos, depending on the time of year.'''.replace( '\n', ' ' ),
      '''Kookaburras are warm weather birds, and thus are only comfortable outside during the warmer months of the year, roughly from
         May to September.'''.replace( '\n', ' ' ),
      ...
      '''Kookaburras are native to eastern Australia and New Guinea, inhabiting open forests, woodlands, and urban areas. They prefer
         environments with scattered trees and perches that allow them to hunt and call over their territory.'''.replace( '\n', ' ' ),
      '''They are carnivorous, feeding on insects, small mammals, reptiles, and amphibians. Kookaburras hunt by perching silently and
         swooping down on prey. At the zoo, they are provided with a diet that mirrors their natural hunting behaviour, including
         insects, small rodents, and other appropriate protein sources.'''.replace( '\n', ' ' ),
      '''Kookaburras are social birds, often seen in family groups. They are territorial and use their distinctive call to communicate
         with others and mark boundaries. They are generally diurnal and spend much of the day perched and observing their
         surroundings.'''.replace( '\n', ' ' ),
      '''Strong, sturdy beaks allow them to capture and kill prey efficiently. Their plumage provides camouflage among trees, and their
         keen eyesight enables precise strikes. Loud, recognizable calls help maintain social cohesion and deter intruders.'''
         .replace( '\n', ' ' ),
      '''Kookaburras nest in tree hollows or termite mounds. Females lay 2–4 eggs, with both parents participating in incubation and
         feeding of the chicks. Juveniles fledge after several weeks. In the wild, kookaburras typically live up to 15–20 years, while
         in captivity they may live longer with proper care.'''.replace( '\n', ' ' ),
   ...
   ( # Also in African Rainforest Pavilion
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The Lau banded iguana can be found in Australasia Pavilion in the hallway past the aviary and to the left. The igunas live in
         the habitat right at the end of the hallway, beside the wombats. In this habitat, the iguanas like to lay on top of the
         branches near the top and sides of the enclosure. In the African Rainforest Pavilion, the iguanas can be found about halfway
         through the pavilion near the chameleons and naked mole rats, in between the cichlids and the pygmy hippos.'''
         .replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The Lau Banded Iguana is a small, vibrant lizard notable for its bright green body with distinctive pale blue or white
         transverse bands across the back. Males are generally brighter than females, especially during the breeding season. It has a
         slender body, long tail, and sharp claws adapted for climbing. This species belongs to the iguana family (Iguanidae) and is
         easily recognised by its striking colour pattern.'''.replace( '\n', ' ' ),
      '''Native to the islands of Lau in Fiji, this iguana inhabits tropical forests and coastal vegetation, often living in trees or
         shrubs. It prefers warm, humid environments with plenty of foliage for cover and sunning.'''.replace( '\n', ' ' ),
      '''The Lau Banded Iguana is primarily herbivorous, feeding on leaves, flowers, fruits, and shoots. Occasionally, it may consume
         insects or small invertebrates. At the zoo, their diet includes a variety of leafy greens, vegetables, and fruits, carefully
         balanced to reflect natural feeding habits and maintain vibrant colouring.'''.replace( '\n', ' ' ),
      '''These iguanas are generally solitary and territorial, especially males. They are diurnal, spending much of the day basking in
         sunlight to regulate body temperature. Males may display head-bobbing and dewlap extension to assert dominance or during
      ...
      '''Mating occurs in the warmer months, with females laying clutches of 2–7 eggs in shallow nests on the ground or in leaf litter.
         Hatchlings emerge fully independent. In the wild, these iguanas can live up to 15 years, while captive individuals may live
         longer with proper care.'''.replace( '\n', ' ' ),
      '''The Toronto zoo is home to a pair of Lau banded iguanas which live in the Australasia Pavilion, and another pair which lives
         in the African Rainforest Pavilion.'''.replace( '\n', ' ' ),
   ),
   (
      'Lionfish',
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      ...
      None,                                                          # Seasonal viewing tips
      '''The lionfish is a venomous marine fish known for its dramatic appearance, with long, flowing pectoral fins and spiky, striped
         dorsal fins. Its body is reddish-brown with white vertical stripes, giving it a “lion-like” mane effect. Belonging to the
         scorpionfish family (Scorpaenidae), it is instantly recognisable by its ornate fins and bold patterning.'''
         .replace( '\n', ' ' ),
      '''Lionfish are native to the Indo-Pacific region, inhabiting coral reefs, lagoons, and rocky crevices. They are typically found
         at depths of 2–60 metres, favouring complex reef structures that provide shelter and hunting opportunities.'''
         .replace( '\n', ' ' ),
      '''Lionfish are carnivorous ambush predators, feeding on small fish, crustaceans, and invertebrates. They use their wide pectoral
         fins to corner prey before striking rapidly. In aquariums, they are fed a diet of small fish and crustaceans, often delivered
         to encourage natural hunting behaviours.'''.replace( '\n', ' ' ),
      '''Lionfish are generally solitary, occupying defined territories. They are slow-moving and deliberate, relying on camouflage and
         their striking fins to intimidate or confuse potential threats. While venomous, they are generally passive unless provoked.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''Live coral reefs are complex underwater ecosystems formed by colonies of tiny animals called coral polyps. These polyps
         secrete calcium carbonate skeletons that build the reef structure over time. The reefs are home to a vast array of organisms,
         including fish, invertebrates, algae, and microorganisms. Colourful corals display hues of red, orange, pink, purple, and
         green, contributing to the visual richness of the habitat.'''.replace( '\n', ' ' ),
      '''Coral reefs are found in warm, shallow, tropical oceans around the world, particularly in the Indo-Pacific region, the
         Caribbean, and parts of the Indian Ocean. They thrive in clear, sunlit waters where temperature, salinity, and water quality
         are stable. Reefs provide shelter, breeding grounds, and feeding areas for countless marine species.'''.replace( '\n', ' ' ),
      ...
      '''While corals themselves are sessile, the reef ecosystem is highly dynamic. Fish and invertebrates interact continuously —
         schooling, foraging, cleaning, and defending territories. Coral polyps reproduce both sexually and asexually, contributing to
         reef growth and recovery.'''.replace( '\n', ' ' ),
      '''Corals have evolved symbiosis with algae to survive in nutrient-poor waters. Their calcium carbonate skeletons protect polyps
         and provide habitat for other species. Many reef inhabitants have camouflage, bright warning colours, or specialized feeding
         adaptations to thrive within the complex reef structure.'''.replace( '\n', ' ' ),
      '''Corals reproduce via broadcast spawning, releasing eggs and sperm into the water simultaneously, or through budding (asexual
         reproduction). Reef ecosystems develop slowly over decades or centuries. Individual coral colonies can live for decades,
         while the reef as a whole can persist for thousands of years under favourable conditions.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Longnose Butterflyfish is a small, colourful reef fish recognised by its elongated, pointed snout and bright yellow body.
         Its face and dorsal area are marked with black stripes, and the fins are mostly yellow with translucent edges. It belongs to
         the butterflyfish family (Chaetodontidae) and is easily recognised by its distinctive snout, which helps it reach food in
         narrow crevices.'''.replace( '\n', ' ' ),
      '''This species is native to the Indo-Pacific region, including coral reefs around Hawaii, Australia, and Southeast Asia. It
         ...
         .replace( '\n', ' ' ),
      '''Longnose Butterflyfish feed primarily on small invertebrates, coral polyps, and crustaceans. Their long, pointed snout allows
         them to extract prey from crevices in coral. In aquariums, they are provided with a diet that replicates their natural feeding
         behaviour, including small invertebrates and specialized reef fish pellets.'''.replace( '\n', ' ' ),
      '''These fish are usually seen in pairs or small groups. They are diurnal and highly active during the day, patrolling reef areas
         for food. Longnose Butterflyfish are territorial, particularly around feeding zones, and use body displays and fin movements 
         to signal dominance or courtship.'''.replace( '\n', ' ' ),
      '''The elongated snout is a specialised adaptation for extracting prey from tight coral spaces. Their bright colouration acts as
         both camouflage among corals and a signal to conspecifics during social interactions. Laterally compressed bodies allow agile
         movement through complex reef structures.'''.replace( '\n', ' ' ),
      '''Longnose Butterflyfish reproduce through external fertilization, with females releasing eggs into the water column where males
         fertilise them. The eggs hatch into free-swimming larvae, which eventually settle on coral reefs as juveniles. In the wild,
         they can live up to 7–10 years, while in captivity they may live slightly longer under proper care.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'MacLeay\'s Spectres',
      ...
      '''These insects are herbivorous, feeding primarily on leaves, especially eucalyptus. They are slow-moving and rely on camouflage
         rather than speed to avoid being eaten. In captivity, they are provided with a diet of suitable leaves and occasionally soft 
         plant material to maintain health.'''.replace( '\n', ' ' ),
      '''MacLeay’s Spectres are largely solitary and nocturnal, becoming more active at night. When disturbed, they remain motionless
         or sway gently to mimic surrounding vegetation. Their stick-like appearance and slow movements are their primary defence
         against predators.'''.replace( '\n', ' ' ),
      '''Exceptional camouflage allows them to evade visual predators. Spiny projections deter predators from handling them. They can
         also shed limbs if caught, which may later regenerate. Their slow metabolism allows survival on a leaf-only diet.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''Malagasy Rainbowfish are omnivorous, feeding on insects, crustaceans, algae, and small plant matter. In aquariums, they are
         offered a mix of flake food, live or frozen insects, and plant-based foods to mimic their natural diet and encourage foraging
         behaviour.'''.replace( '\n', ' ' ),
      ...
      '''Their streamlined bodies and strong tails allow agile swimming through vegetation and currents. Colouration plays a key role
         in mating displays and social signalling within schools. Their omnivorous diet and flexibility help them survive in variable
         freshwater environments.'''.replace( '\n', ' ' ),
      '''Malagasy Rainbowfish reproduce by laying small eggs on submerged vegetation or surfaces. Eggs hatch in about 7–10 days, with
         juveniles growing rapidly under optimal conditions. Lifespan is typically 3–5 years in captivity, with good water quality and
         diet contributing to longevity.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Moon Jellyfish',
      ...
      '''Moon jellyfish are carnivorous, feeding primarily on plankton, small crustaceans, fish eggs, and larvae. They capture prey
         using stinging cells (cnidocytes) on their tentacles, which paralyse and guide food to the mouth. In aquaria, they are fed a
         diet of live or frozen planktonic foods.'''.replace( '\n', ' ' ),
   ...
   ( # Also in Indo-Malaya Pavilion
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''Nicobar pigeons can be spotted in the main aviaries in the Australasia and Indo-Malaya Pavilions. In the Indo-Malaya Pavilion
         you can spot them most reliably when going down the staircase from the elevated Sumatran orangutan viewing, or along the part
         of the path between the Asian tortoises and the reticulated python, or across where you access the outdoor orangutan habitat.
         '''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''Native to small islands in the Nicobar Islands, Southeast Asia, and the western Pacific, Nicobar Pigeons inhabit coastal
         forests, mangroves, and wooded areas near beaches. They are often found on remote islands, where they roost and forage safely
         from predators.'''.replace( '\n', ' ' ),
      ...
      '''Their strong legs and feet allow efficient ground foraging, while their iridescent feathers play a role in courtship and
         ...
         .replace( '\n', ' ' ),
      '''Nicobar Pigeons form monogamous pairs during the breeding season. They nest in trees or shrubs, laying a single egg, which is
         incubated by both parents. Chicks fledge after a few weeks but remain under parental care for some time. In captivity, they
         can live up to 15–20 years, while wild lifespans are generally slightly shorter.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Pennant Coral Fish',
      ...
      '''The Pennant Coralfish, also known as the Longfin Bannerfish, is a striking marine fish recognised by its tall, triangular
         ...
         belongs to the butterflyfish family (Chaetodontidae) and is easily recognised by its contrasting colour pattern and elongated
         dorsal fin.'''.replace( '\n', ' ' ),
      ...
      '''Pennant Coralfish are omnivorous, feeding on small invertebrates, plankton, and occasionally algae. They use their small,
         protrusible mouths to pick food from crevices in the coral. In aquariums, they are fed a mix of frozen or live invertebrates,
         supplemented with plant-based foods to mimic natural foraging behaviour.'''.replace( '\n', ' ' ),
      ...
      '''The tall dorsal fin and contrasting colour pattern may help with species recognition and predator confusion. Their laterally
         compressed bodies allow agile movement through complex coral structures, and their small mouths are adapted for precision
         feeding on small prey items.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Pied Imperial Pigeon is a large, stocky pigeon with predominantly white plumage, contrasting with dark flight feathers on
         the wings and tail. It has a short, stout beak and a pale yellow or orange eye. Belonging to the pigeon and dove family
      ...
      '''These pigeons are frugivorous, feeding primarily on fruits, berries, and figs. They forage in trees and occasionally descend
         to feed on fallen fruit. In zoos, their diet includes a variety of fruits and supplements that mimic their natural intake,
         ensuring proper nutrition.'''.replace( '\n', ' ' ),
      '''Pied Imperial Pigeons are social and often seen in flocks. They are strong, direct fliers and communicate with soft cooing
         ...
         .replace( '\n', ' ' ),
      '''Their strong wings and lightweight bodies are adapted for long flights between islands and across open habitats. Frugivorous
         diets are supported by a digestive system capable of processing fibrous fruits efficiently. Their contrasting plumage aids in
         social signalling and species recognition during flight and display.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Pot-bellied Seahorses are native to southern Australia and Tasmania, inhabiting seagrass beds, kelp forests, and sheltered
         coastal waters. They prefer areas with plenty of holdfasts, such as seagrass, coral, or man-made structures, to anchor their
         tails.'''.replace( '\n', ' ' ),
      ...
      '''Pot-bellied Seahorses are generally solitary but form monogamous pairs during the breeding season. They are slow-moving and
         rely on camouflage to avoid predators. Males and females perform elaborate courtship dances that strengthen pair bonds before
         mating.'''.replace( '\n', ' ' ),
      '''The prehensile tail allows seahorses to anchor to vegetation and resist currents, while their vertical posture helps them
         blend into seagrass or kelp. Camouflaged colouring and small size reduce predation risk. Their unique body shape allows them
         to feed efficiently on tiny planktonic organisms.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The red claw yabbies can be seen in a tank enclosure in the room in the Australasia Pavilion past the aviary and to the right.
         ''',
      None,                                                          # Seasonal viewing tips
      '''The Red Claw Yabby is a freshwater crayfish distinguished by its robust body, dark green to bluish-grey carapace, and bright
         red tips on the larger claws. Adults can reach up to 20 cm in length. This species belongs to the crayfish family
         (Parastacidae) and is easily recognised by its red claws and segmented, armored body.'''.replace( '\n', ' ' ),
      '''Native to northern Australia and parts of Papua New Guinea, Red Claw Yabbies inhabit rivers, billabongs, and freshwater lakes.
         They prefer environments with soft substrates and plenty of cover such as rocks, vegetation, or burrows to hide from
         predators.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Native to northern Australia and southern New Guinea, these turtles inhabit slow-moving rivers, swamps, and freshwater
         ...
         .replace( '\n', ' ' ),
      '''Red-bellied Short-necked Turtles are omnivorous, feeding on aquatic plants, algae, small fish, invertebrates, and carrion. In
         captivity, their diet includes leafy greens, vegetables, commercial turtle pellets, and protein supplements to ensure
      ...
      '''Breeding occurs during warmer months, with females laying clutches of 10–20 eggs in sandy or soft soil near water. Hatchlings
         emerge fully independent and begin foraging immediately. Lifespan is typically 20–30 years in the wild, and turtles in
         captivity can live longer with proper care.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The red-tailed black cockatoos live in the first enclosure you encounter when you enter the pavilion. They share their habitat
         with the short-beaked echidna.''',
      None,                                                          # Seasonal viewing tips
      '''The Red-tailed Black Cockatoo is a large, striking parrot with glossy black plumage and bright red panels on the tail feathers
         in males, while females have more subdued brownish-red tail markings and spotted plumage on the body. It has a strong, curved
         beak and a prominent crest that can be raised or lowered. This species belongs to the cockatoo family (Cacatuidae) and is
         instantly recognisable by its size and dramatic colouring.'''.replace( '\n', ' ' ),
      '''Red-tailed Black Cockatoos are native to Australia, inhabiting woodlands, forests, and savannah regions, often near water
         ...
         .replace( '\n', ' ' ),
      '''These cockatoos feed primarily on seeds, nuts, fruits, and native vegetation. Their strong beaks allow them to crack open hard
         seeds and access otherwise protected food sources. In zoos, they are provided with a varied diet of seeds, fruits, nuts, and
         formulated pellets to reflect natural feeding behaviour.'''.replace( '\n', ' ' ),
      '''Red-tailed Black Cockatoos are social and often seen in pairs or small flocks. They are vocal, producing distinctive calls and
         whistles to communicate. Males may display to attract mates, raising their crest and fanning their tail feathers. They are
         diurnal and spend much of the day foraging or perching in trees.'''.replace( '\n', ' ' ),
      '''Strong, curved beaks allow them to access tough seeds and nuts, while zygodactyl feet (two toes forward, two back) help them
         grip branches and manipulate food. Their black plumage provides camouflage in dense forest canopies, and their social
         behaviour enhances survival by maintaining group vigilance against predators.'''.replace( '\n', ' ' ),
      '''Breeding typically occurs in spring and summer. Females nest in large tree hollows, laying 1–2 eggs per clutch. Both parents
         participate in feeding and caring for the chicks. Juveniles fledge after several weeks but may remain with parents for
         extended learning. In the wild, Red-tailed Black Cockatoos can live up to 50 years, while captive individuals often live
         longer with proper care.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The short-beaked echidna shares a habitat with the red-tailed black cockatoos. This habitat is the first one you see after you
         enter the Australasia Pavilion. The short-beaked echidna is perhaps the most difficult animal to spot at the zoo. This is
         because the species is nocturnal, and rarely exits its burrow during the day. Your best chance of spotting the echidna is to
         visit the Australasia pavilion right at the end of the day, and looking around the bottom of its enclosure.'''
         .replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The Short-beaked Echidna is a small, spiny monotreme with a distinctive coat of coarse hair and sharp spines covering its
         back. It has a long, slender snout used for probing, a sticky tongue for capturing prey, and strong, clawed limbs for digging.
         Belonging to the monotreme family (Tachyglossidae), it is one of only a few egg-laying mammals in the world.'''
         .replace( '\n', ' ' ),
      '''Native to Australia and Tasmania, Short-beaked Echidnas inhabit a variety of environments, including forests, grasslands, and
         deserts. They prefer areas with loose soil for burrowing and ample invertebrate prey.'''.replace( '\n', ' ' ),
      '''Echidnas are insectivorous, feeding mainly on ants and termites. They use their strong claws to dig into nests and their long,
         sticky tongue to capture prey. In captivity, their diet includes specially formulated insect-based foods and live
      ...
      '''Short-beaked Echidnas are solitary and primarily nocturnal or crepuscular. They spend much of the day resting in burrows or
         under cover. When threatened, they curl into a ball, presenting their spines to predators. They communicate minimally, using
         grunts or snuffles during social encounters or mating.'''.replace( '\n', ' ' ),
      '''The spines provide protection from predators, while strong limbs and claws allow efficient digging. The long, sensitive snout
         helps detect prey underground. Their low metabolic rate and ability to enter torpor allow them to survive in a wide range of
         temperatures and food availability.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The Solomon Island leaf frogs live in one of the first enclosures you see once you enter the Great Barrier Reef exhibit in the
         Australasia Pavilion.''',
      None,                                                          # Seasonal viewing tips
      '''The Solomon Island Leaf Frog is a small, terrestrial frog with a flattened, leaf-like body and cryptic brown, green, or
         ...
         jumping. Belonging to the family Ceratobatrachidae, it is recognised for its remarkable camouflage and distinctive leaf-like
         appearance.'''.replace( '\n', ' ' ),
      ...
      '''Solomon Island Leaf Frogs are insectivorous, feeding primarily on ants, termites, small insects, and other invertebrates. In
         captivity, they are offered a diet of small insects such as crickets and fruit flies, replicating natural foraging behaviour.
         '''.replace( '\n', ' ' ),
      '''These frogs are largely solitary and nocturnal, remaining hidden during the day and emerging at night to forage. They rely on
         camouflage for protection and remain motionless when threatened. Males communicate with soft calls during the breeding season
         to attract mates.'''.replace( '\n', ' ' ),
      '''Their flattened, leaf-like body and cryptic colouration provide excellent camouflage in leaf litter. Long, slender limbs allow
         quick, efficient hopping, and their sticky fingers aid in navigating the forest floor. Being nocturnal helps reduce predation
         risk and avoid heat stress.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Solomon Island Monkey-tailed Skink is a large, arboreal lizard with a long, prehensile tail, robust body, and a darkgreen
         to olive-brown colouration. Adults can reach up to 60–70 cm in length. It belongs to the skink family (Scincidae) and is
         easily recognised by its elongated, grasping tail and strong limbs adapted for climbing.'''.replace( '\n', ' ' ),
      ...
      '''These skinks are generally social, often seen in small family groups. They are mostly diurnal, spending daylight hours
         basking or moving slowly among branches. Their prehensile tails allow them to maintain balance while climbing and navigating
         the canopy. When threatened, they may use tail-whipping as a defensive behaviour.'''.replace( '\n', ' ' ),
      '''The prehensile tail acts like a fifth limb for grasping branches, while sharp claws aid in climbing. Their cryptic
         greenish-brown colouring provides camouflage among leaves. Slow, deliberate movements help them avoid detection by predators
         and conserve energy.'''.replace( '\n', ' ' ),
      '''Solomon Island Monkey-tailed Skinks give birth to live young (viviparous reproduction), usually 2–8 per litter. Juveniles are
         fully independent at birth. Lifespan in the wild can reach 15–20 years, with captive individuals sometimes living longer
         under optimal care.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      0,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The wombats can be viewed both inside and outside. To see their indoor habitat, head inside the Australasia Pavilion, and go
         to the left once you exist the aviary area. To spot them in their outdoor habitat, you may walk through the pavilion, and
         their enclosure will be on the left when you exit, or take a walk around the outside of the pavilion, towards the exit. The
         wombats are most active closer to dusk or dawn. They spend much of the daytime sleeping, and during these lazy hours they
      ...
      '''Wombats are warm weather animals, and tend to only venture outside in the warmer months of the year. They are also generally
         less active in the winter, spending more time sleeping in their burrows. Even in the warmer months, the wombats are often
         found in their indoor habitat in the Australasia Pavilion.'''.replace( '\n', ' ' ),
      '''The Southern Hairy-nosed Wombat is a robust, burrowing marsupial with a compact, muscular body covered in coarse grey-brown
         ...
         Adults typically weigh 25–35 kg and measure around 1 metre in length. This species belongs to the wombat family (Vombatidae)
         and is easily recognised by its stocky build and characteristic nose shape.'''.replace( '\n', ' ' ),
      '''Native to semi-arid and arid regions of southern Australia, Southern Hairy-nosed Wombats inhabit grasslands, scrublands, and
         sandy plains. They rely on soft soils for extensive burrow systems, which provide shelter from heat, cold, and predators.
         These wombats are highly adapted to dry environments and can survive in areas with sparse vegetation.'''
         .replace( '\n', ' ' ),
      '''Southern Hairy-nosed Wombats are herbivorous, feeding primarily on native grasses, roots, and tubers. They have strong,
         ...
         hay, leafy greens, and fibre-rich vegetables, supplemented to mimic their natural nutrient intake. They are mostly nocturnal
         feeders, emerging at night to graze.'''.replace( '\n', ' ' ),
      '''These wombats are generally solitary, defending individual burrow systems but may tolerate neighbours at boundaries. They are
         nocturnal, spending the day hidden in burrows to avoid extreme temperatures. Burrow systems are complex, with multiple
         entrances and chambers, and are central to their territorial behaviour. They mark territory with scent and dung placed at the
         burrow entrances. Though generally slow-moving, wombats are capable of surprising bursts of speed when threatened.'''
         .replace( '\n', ' ' ),
      '''Southern Hairy-nosed Wombats are highly adapted to survive in arid and semi-arid environments. Their powerful limbs and sharp
         claws allow them to dig extensive burrow systems, which provide protection from extreme temperatures and predators. They have
         highly efficient kidneys and extract most of their water from the vegetation they eat, enabling them to thrive where free
         water is scarce. Their continuously growing incisors are perfectly suited for grinding tough, fibrous grasses and roots.
         Being primarily nocturnal helps them avoid daytime heat and predation, while their stocky, low-slung bodies conserve energy
         and aid in digging and moving through burrows.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Stimson’s Python is a small to medium-sized, non-venomous snake, typically reaching 1–2 metres in length. It has a slender,
         cylindrical body with smooth scales, and its colouration ranges from reddish-brown to tan with pale markings along the back.
         Belonging to the python family (Pythonidae), it is recognised for its gentle temperament and manageable size, making it
         popular in captivity.'''.replace( '\n', ' ' ),
      ...
      '''Stimson’s Pythons are generally solitary and nocturnal, active mainly at night when they hunt. They are non-aggressive toward
         humans but will defend themselves if threatened. In captivity, they are known for their calm, docile nature and often
         tolerate careful handling.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Tawny Frogmouth is a medium-sized nocturnal bird with mottled grey, brown, and black plumage that closely resembles tree
         bark. It has a broad, flattened head, large eyes adapted for low light, and a wide, frog-like beak surrounded by stiff
      ...
      '''Tawny Frogmouths are nocturnal and usually seen alone or in pairs. During the day, they remain motionless on branches,
         relying on camouflage to avoid detection. When threatened, they adopt a distinctive posture by stretching their necks upward
         and closing their eyes to resemble a broken branch. They are territorial and communicate using a range of low, booming calls
         at night.'''.replace( '\n', ' ' ),
      ...
      '''Breeding typically occurs from spring to early summer. Pairs build a flimsy nest of sticks on a horizontal branch, where the
         female lays 1–3 eggs. Both parents share incubation and chick-rearing duties. Chicks fledge after about a month. Tawny
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Thorny Devil Stick Insect is a large, leaf-mimicking insect with an irregular, spiny body covered in lobes and thorn-like
         projections. Colouration varies from brown to grey and green, closely resembling dried leaves or bark. Females are
         significantly larger and heavier than males, while males are slimmer and capable of flight. This species belongs to the stick
         insect family (Phasmatidae) and is renowned for its exceptional camouflage.'''.replace( '\n', ' ' ),
      '''Native to eastern Australia, Thorny Devil Stick Insects inhabit forests and woodlands where leaf litter and dense vegetation
         provide cover. They are most commonly found among eucalyptus trees, where their appearance blends seamlessly with surrounding
         foliage.'''.replace( '\n', ' ' ),
      '''These insects are herbivorous, feeding primarily on eucalyptus leaves, as well as other suitable native plants. In zoos, they
         are provided with fresh leafy branches, which also serve as climbing and resting structures. Feeding occurs mostly at night.'''
         .replace( '\n', ' ' ),
      ...
      '''Females lay eggs by dropping them to the forest floor, where they resemble seeds. Eggs hatch after several months, producing
         tiny nymphs that closely resemble ants, helping deter predators. As they grow, they shed their exoskeleton multiple times
         before reaching adulthood. Lifespan is typically 6–12 months, depending on environmental conditions.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      '''The Threadfin Butterflyfish’s elongated snout is perfectly adapted for extracting food from narrow spaces within coral reefs.
         Its bold colour patterns help with species recognition, while the false eyespot may misdirect predators during attacks. The
         dorsal filament may play a role in communication or display.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Victoria Crowned Pigeon is the largest species of pigeon in the world, notable for its striking blue-grey plumage and
         elaborate fan-shaped crest of lacy feathers tipped with white. It has deep red eyes, a maroon chest, and strong reddish legs.
         Adults can reach over 70 cm in length and weigh up to 2.5 kg. Despite its size, it retains the classic pigeon body shape,
         making it both impressive and distinctive.'''.replace( '\n', ' ' ),
      '''This species is native to the lowland rainforests and swamp forests of northern New Guinea and surrounding islands. It spends
         much of its time on the forest floor but relies on trees for roosting and nesting. Dense vegetation and undisturbed forest
         habitats are essential for its survival.'''.replace( '\n', ' ' ),
      '''Victoria Crowned Pigeons are primarily frugivorous, feeding on fallen fruits, seeds, and berries found on the forest floor.
         They also consume insects and small invertebrates on occasion. In zoos, they are offered a carefully balanced diet of fruits,
         grains, seeds, and formulated feeds that support their nutritional needs.'''.replace( '\n', ' ' ),
      '''These pigeons are generally calm and social, often seen in pairs or small groups. They are diurnal and spend much of the day
         walking slowly along the ground in search of food. When alarmed, they can take flight with loud wing claps, although they
         prefer to avoid flying when possible. They communicate using deep, resonant calls that can carry through dense forest.'''
         .replace( '\n', ' ' ),
      '''The Victoria Crowned Pigeon’s large size and strong legs allow it to forage efficiently on the forest floor, while its
         powerful wings enable short flights to escape danger or reach roosting sites. Its ornate crest may play a role in display and
         communication, especially during courtship. The bird’s muted but elegant colouring provides some camouflage in shaded forest
   ...
   (
      ...
      '''White’s Tree Frog is a large, robust tree frog with smooth, waxy skin that ranges from bright green to bluish-green, often
         with pale white or cream markings along the sides. It has large toe pads adapted for climbing and prominent golden eyes with
         horizontal pupils. Adults typically grow 7–11 cm in length. This species is also commonly known as the Australian Green Tree
         Frog.'''.replace( '\n', ' ' ),
      '''Native to northern and eastern Australia and parts of New Guinea, White’s Tree Frogs inhabit a wide variety of environments,
         including forests, wetlands, grasslands, and urban areas. They are often found near water sources but are highly adaptable
         and can tolerate drier conditions better than many other amphibians.'''.replace( '\n', ' ' ),
      ...
      '''White’s Tree Frogs are primarily nocturnal and are often seen resting during the day in sheltered locations such as tree
         hollows or behind foliage. They are relatively tolerant of one another and may be observed sharing resting sites. During the
         breeding season, males produce loud, deep calls near water to attract females.'''.replace( '\n', ' ' ),
      '''This species has several adaptations that allow it to thrive in a wide range of conditions. Its large toe pads provide
         excellent grip for climbing smooth surfaces, while its waxy skin helps reduce moisture loss, allowing it to survive in drier
         habitats. White’s Tree Frogs can also store water in their bodies and adjust their activity patterns to avoid extreme heat.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Western Grey Kangaroo is a large marsupial with thick grey-brown fur, a pale underside, and a robust, muscular build. It
         has powerful hind legs, large feet adapted for hopping, and a long, muscular tail used for balance and support. Males are
         significantly larger than females and may show darker facial markings and heavier musculature. Adults can reach over 1.3
         metres in body length, with tails adding nearly another metre.'''.replace( '\n', ' ' ),
      ...
      '''Western Grey Kangaroos are herbivorous grazers, feeding primarily on grasses and other low-growing vegetation. They are
         adapted to digest tough, fibrous plant material through a complex, multi-chambered stomach similar to that of ruminants. At
         the zoo, they are fed a diet of grasses, hay, and specially formulated herbivore pellets, supplemented with fresh browse.'''
         .replace( '\n', ' ' ),
      ...
      '''Western Grey Kangaroos possess a suite of adaptations for efficient movement and survival in open landscapes. Their powerful
         hind legs and elastic tendons allow them to travel long distances while conserving energy through hopping. The thick tail
         acts as a counterbalance and a powerful support limb when moving slowly or standing upright. Their digestive system enables
         them to extract nutrients from low-quality forage, and their ability to regulate activity patterns helps them cope with heat
         and limited water availability.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Amur tiger habitat is located near the entrance to the Eurasia Wilds exhibit, towards the right near the kangaroo habitat.
         The Amur tigers at the zoo have several spaces which they can be in during any given day. From closest the kangaroos to
         furthur away, there is the main habitat with the pool and den, two indoor spaces, and the secondary outdoor habitat. For a
         year-round, comfortable experience, the tigers at the zoo always have access to indoor and outdoor spaces. Specifically when
         it is warmer, the tiger may be in one of her indoor habitats, past the main habitat and on the left. Amur tigers are most
      ...
      '''The Amur tiger, also known as the Siberian tiger, is the largest living cat species. It has a thick, pale orange coat with
         widely spaced black stripes and a white underside, adaptations that help it blend into snowy forest environments. Compared to
         other tiger subspecies, it has longer fur, a thicker layer of body fat, and a broader head. Adult males can exceed 300 kg,
         making them among the most powerful terrestrial predators on Earth.''' .replace( '\n', ' ' ),
      '''Amur tigers are native to the temperate forests of the Russian Far East, with small populations historically extending into
         northeastern China and the Korean Peninsula. They inhabit boreal forests, mixed woodlands, and mountainous regions, often in
         areas with harsh winters, deep snow, and rugged terrain. Large, undisturbed territories are essential for their survival.'''
         .replace( '\n', ' ' ),
      '''These tigers are apex predators that primarily hunt large ungulates such as deer and wild boar. They rely on stealth,
         ...
         .replace( '\n', ' ' ),
      '''Amur tigers are solitary and highly territorial. Each individual maintains a vast home range, marked with scent markings and
         scratch marks on trees. They are mostly crepuscular, being most active at dawn and dusk. Despite their solitary nature, they
      ...
      '''Amur tigers are exceptionally well adapted to cold climates. Their thick fur and dense fat layer provide insulation against
         ...
         across snow. Their striped coat offers camouflage in forested environments, breaking up their outline among trees and shadows.
         Powerful forelimbs and retractable claws enable them to subdue large prey efficiently.'''.replace( '\n', ' ' ),
      '''Breeding can occur year-round. After a gestation period of about 3.5 months, females give birth to litters of 2–4 cubs. Cubs
         remain with their mother for up to two years, learning essential hunting and survival skills. In the wild, Amur tigers
         typically live 10–15 years, while individuals in captivity may live 20 years or more with proper care.'''.replace( '\n', ' ' ),
      '''The Toronto Zoo is home to one female Amur tiger, Mazy. Mazy is in her golden years, and will spend much of her time resting,
         but you can still see her being active, specifically in the cooler months and earlier in the day, or whenever she is being
         given enrichment. Mazy is past her breeding days, and will remain alone, as she likes it, for the rest of her days at the zoo.
         '''.replace( '\n', ' ' )
   ),
   (
      'Asian Wild Horse',
      ...
      5,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The Asian wild horses can be spotted at two spots in the Eurasia Wilds region of the zoo. A pair of the zoo's older horses can
         be spotted in a habitat across from the West Caucasian turs across the river. The rest of the herd can be spotted up-close in
         the Eurasia Wilds drive-thru exhibit aboard the zoomobile. To go through the drive-through you must hop on zoomobile before 
         the Eurasia stop and stay on after the Tundra Trek stop.'''.replace( '\n', ' ' ),
      ...
      '''The Asian Wild Horse, also known as Przewalski’s horse, is a stocky, muscular horse with a large head, short neck, and
         ...
         marked with faint striping. Unlike domestic horses, it has a heavier build, shorter legs, and a more robust skull, reflecting
         its wild ancestry.'''.replace( '\n', ' ' ),
      '''Historically, Asian Wild Horses ranged across the steppes and semi-deserts of Central Asia. By the mid-20th century, they
         ...
         to protected areas in Mongolia and parts of China. They inhabit open grasslands, desert steppe, and arid plains with extreme
         seasonal temperatures.'''.replace( '\n', ' ' ),
      '''Asian Wild Horses are grazing herbivores, feeding primarily on grasses, sedges, and other hardy steppe vegetation. They are
         adapted to forage on coarse, low-nutrient plants and can dig through snow to reach buried grasses in winter. At the zoo, they
         are fed hay, grasses, and specialized equine diets that reflect their natural feeding behaviour.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Domestic Yaks are native to the high-altitude regions of the Himalayas, Tibetan Plateau, and Central Asia. They inhabit cold,
         mountainous grasslands and alpine meadows, thriving at elevations above 3,000 metres. Domesticated yaks are found throughout
         these regions, providing transport, milk, meat, and fibre for local communities.'''.replace( '\n', ' ' ),
      ...
      '''Breeding typically occurs during the summer months. After a gestation period of approximately 9 months, females give birth to
         a single calf. Calves are able to stand and walk within hours, following the herd for protection. Domestic Yaks can live
   ...
   (
      ...
      '''Originally from the Scottish Highlands, Highland Cattle are well suited to cold, wet, and windy environments. They thrive in
         mountainous pastures, moorlands, and open grasslands. At the zoo, they are provided with large outdoor enclosures that
         replicate open, grassy habitats.'''.replace( '\n', ' ' ),
      '''Highland Cattle are herbivorous grazers, feeding primarily on grasses, shrubs, and coarse vegetation. Their strong digestive
         systems allow them to extract nutrients from fibrous plant material. In managed care, they are fed hay, grasses, and
         supplemental feed to maintain health and encourage natural grazing behaviours'''.replace( '\n', ' ' ),
      ...
      '''Highland Cattle are adapted to cold, wet climates. Their long, double-layered coat provides insulation against rain, wind,
         and snow, while their large, muscular build helps conserve heat. Broad hooves allow them to traverse soft or uneven terrain,
         and their efficient digestion enables them to thrive on coarse forage.'''.replace( '\n', ' ' ),
      '''Breeding occurs year-round in managed populations, with a gestation period of approximately 9 months. Calves are born
         relatively well-developed and can stand and follow the herd shortly after birth. Lifespan typically ranges 15–20 years, with
         careful management in zoos often extending longevity.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      -30,                                                           # Minimum temperature (only for animals with outdoor viewing)
      5,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The mouflon can be spotted at the mouth of the Eurasia Wilds loop, just past the sign with the bactrian camel and wild horse
         at the base.'''.replace( '\n', ' ' ),
      ...
      '''Mouflon are primarily grazers, feeding on grasses, herbs, and shrubs. Their digestive system allows them to extract nutrients
         efficiently from tough, fibrous vegetation. At the zoo, they are provided with a mix of grasses, hay, and browse to encourage
      ...
      '''Mouflon are social animals, forming herds structured by age and sex. Males may compete for dominance during the breeding
         season through horn clashes and displays of strength. Herds provide safety in numbers, and group living facilitates learning
         and protection against predators.'''.replace( '\n', ' ' ),
      '''Mouflon are highly adapted to steep, rocky environments. Their strong legs and hooves provide balance and traction on uneven
         terrain, while their agility allows them to escape predators. Horns serve both as weapons during mating competitions and as a
         visual signal of maturity and dominance. Their thick coats protect against cold mountain temperatures, and their alert senses
         help detect danger quickly.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''You can get to the red panda habitat by taking the Eurasia Wilds loop from the side with the Amur tigers. The red panda
         ...
         visit their enclosure first thing in the morning. Through much of the day they spend their time sleeping way up in the trees.
         To spot them in their exhibit, look all the way up to the top branches of the tallest trees in their habitat, and look for a
         couple of red-black furry balls.'''.replace( '\n', ' ' ),
      ...
      '''Red Pandas are mostly solitary and territorial. They are crepuscular and nocturnal, being most active at dawn and dusk. They
         are skilled climbers and spend much of their time in trees, using their bushy tails for balance and warmth. Communication
         occurs through vocalisations, scent markings, and body language.'''.replace( '\n', ' ' ),
      '''Red Pandas are adapted to life in temperate, mountainous forests. Their semi-retractable claws, flexible ankles, and strong
         ...
         .replace( '\n', ' ' ),
      '''Breeding occurs in late winter to early spring. Females give birth to 1–4 cubs in nests lined with leaves and moss, often in
         tree hollows. Cubs are dependent on their mother for several months, gradually learning to climb and forage. Red Pandas can
         live 8–10 years in the wild, with some individuals reaching 14 years in captivity.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The snow leopard habitat can be accessed by taking the Eurasia Wilds loop on the side to the left of the mouflon. You can
         ...
         leopard habitat is designed to mimic the mountainous habitats they originate from. They can often be spotted towards the back
         of the exhibit on top of their rock wall. During the warm months of the year, you may walk up the mountain to get a good
         vantage point of the habitat. They may also lie down in front of the glass viewing inside the cave. A couple of other good
         spots to check are the set of trees across from the West Caucasian tur habitat, and in the dip beside the rocks by the
      ...
      '''Snow Leopards are carnivorous apex predators, primarily hunting wild ungulates such as bharal (blue sheep), ibex, and argali.
         They also take smaller mammals, birds, and occasionally livestock. In captivity, their diet is managed with a variety of
         raw meat and enrichment feeding that encourages stalking, pouncing, and natural predatory behaviours.'''.replace( '\n', ' ' ),
      ...
      '''The zoo is home to four snow leopards: an adult male, Pemba who goes in exhibit by himself on Mondays, Wednesdays, and
         Fridays, and a mother, Jita, and her two female cubs, Minu and Zoya, who are all on exhibit together on Tuesdays, Thursdays,
         Saturdays,and Sundays. The mother and cubs are nearing the end of their time together on exhibit. Once the cubs become too
         old for their mother, they will be moved to other zoos. Snow leopards are solitary animals, except for during breeding
         season, and a mother and her cubs, hence why Pemba goes on exhibit by himself. The snow leopard cubs are quite active, and
         can often be seen chasing each other, or their mother, around the habitat.'''.replace( '\n', ' ' )
   ),
   (
      'Steller\'s Sea Eagle',
      ...
      '''The Steller’s Sea Eagle is one of the largest eagles in the world, notable for its massive yellow beak, striking
         black-and-white plumage, and powerful build. Adults typically weigh 5–9 kg and have a wingspan of 2–2.5 metres. Their strong
         talons and hooked beak are perfectly adapted for hunting and consuming fish, their primary prey.'''.replace( '\n', ' ' ),
      ...
      '''Steller’s Sea Eagles are generally solitary or found in pairs, though large congregations can form in wintering areas with
         ...
         displays to communicate dominance and defend nesting sites. Flight is powerful and deliberate, allowing them to patrol large
         territories.'''.replace( '\n', ' ' ),
      '''These eagles are well adapted to cold, coastal environments. Their dense feathers provide insulation against frigid
         ...
         allows efficient soaring over long distances, while keen eyesight enables precise hunting in open water and along ice edges.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      -30,                                                           # Minimum temperature (only for animals with outdoor viewing)
      5,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The West Caucasian turs can be spotted in two different habitats in the Eurasia Wilds section of the zoo. The female tur can
         be spotted in a habitat in the main Eurasia Wilds loop, which can be accessed by taking the loop to the left of the mouflon.
         The tur habitat will be the first one you see. The male turs can be found in the Eurasia Wilds drive-thru. To go through the
         drive-through you must hop on zoomobile before the Eurasia stop and stay on after the Tundra Trek stop.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      -40,                                                           # Minimum temperature (only for animals with outdoor viewing)
      5,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The Arctic wolf enclosure is located in the center of the Tundra Trek exhibit. The arctic wolf enclosure at the is very large,
         and has many viewing points. To get the best view of the wolves, you can move 360° around the habitat, and  the Tundra Trek
         exhibit, and you should get a semi-close view. The wolves will generally be more active in the morning, and closer to dusk.'''
         .replace( '\n', ' ' ),
      ...
      '''The Arctic Wolf is a subspecies of gray wolf adapted to the extreme conditions of the Arctic. It has a thick, white to creamy
         coat that provides camouflage in snowy landscapes, small rounded ears to minimize heat loss, and a stocky build with short
         muzzle and legs relative to other wolf subspecies. Adults typically weigh 36–50 kg, with males slightly larger than females.
         '''.replace( '\n', ' ' ),
      '''Native to the Arctic regions of Canada, Greenland, and northern Alaska, Arctic Wolves inhabit tundra, ice fields, and boreal
         forest edges. They are highly adapted to cold, open environments with sparse vegetation and long winters. Denning areas are
         usually sheltered, rocky crevices or snowbanks.'''.replace( '\n', ' ' ),
      '''Arctic Wolves are carnivorous apex predators. Their diet primarily consists of muskoxen, Arctic hares, caribou, and
         occasionally small rodents or birds. In captivity, their diet is managed with meat, bones, and enrichment to simulate hunting
         and feeding behaviours, ensuring physical and mental stimulation.'''.replace( '\n', ' ' ),
      ...
      '''Breeding occurs once a year in late winter. Females give birth to 4–7 pups in dens sheltered from the elements. Both parents,
         along with pack members, help feed and protect the young. Pups grow quickly, joining the pack in hunting by autumn. Lifespan
         in the wild is typically 7–10 years, with captive individuals often living 12–14 years.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Caribou, also known as reindeer in some regions, are medium-to-large Arctic and sub-Arctic ungulates with broad, flat hooves
         and dense fur for insulation. Both males and females grow antlers, though males typically have larger, more branched antlers
         that are shed annually. Their coat changes seasonally, ranging from reddish-brown in summer to silvery-grey in winter,
         providing camouflage and thermal protection.'''.replace( '\n', ' ' ),
      '''Caribou are native to tundra and boreal forest regions across North America, Greenland, and northern Eurasia. They inhabit
         ...
         grounds.'''.replace( '\n', ' ' ),
      '''Caribou are herbivorous, feeding primarily on lichens, mosses, grasses, and shrubs. In winter, lichens (particularly reindeer
         moss) form a critical part of their diet, which they uncover by scraping snow with their hooves. At the zoo, their diet is
         supplemented with hay, browse, and specially formulated herbivore pellets to replicate natural foraging.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      -40,                                                           # Minimum temperature (only for animals with outdoor viewing)
      5,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The lesser snow goose habitat can be found by taking the Tundra Trek loop on the left, on the side close to the Caribou Cafe.
         You will see the snow goose enclosure past the first viewing of the Arctic wolves, on the left.'''.replace( '\n', ' ' ),
      ...
      '''Lesser Snow Geese breed in the Arctic tundra of northern Canada and Alaska. During migration and winter, they travel south to
         wetlands, agricultural fields, and coastal marshes across southern Canada, the United States, and parts of Mexico. They rely
         heavily on open water and grassy or marshy habitats.'''.replace( '\n', ' ' ),
      '''These geese are herbivorous, feeding on grasses, sedges, roots, tubers, and grains. On breeding grounds, they graze on tundra
         vegetation, while during migration and winter they often forage in agricultural fields. At the zoo, they are fed a balanced
         diet of grains, greens, and formulated waterfowl feed.'''.replace( '\n', ' ' ),
      '''Lesser Snow Geese are highly social and form large flocks, sometimes numbering in the tens of thousands. They are monogamous,
         forming long-term pair bonds. Communication includes loud honking calls used to maintain flock cohesion and coordinate
         movement during flight and feeding.'''.replace( '\n', ' ' ),
      '''These geese are well adapted to long-distance migration and cold environments. Their strong wings enable sustained flight
         over vast distances, while dense feathers provide insulation during Arctic breeding seasons. Their bills are well suited for
         grazing and digging up roots, allowing them to exploit a wide range of plant foods.'''.replace( '\n', ' ' ),
   ...
   ( # Also in Canadian Domain
      ...
      '''The Northern bald eagle can be spotted in two different spots--one in the Tundra Trek, and another in the Canadian Domain.
         ...
         larger polar bear grass habitat. The eagle enclosure will be on your left. To see the eagle in the domain, head to the bottom
         of the hill, and head towards the female wood bison paddock, not towards the grizzly bears. The eagle habitat will be on your
         left.'''.replace( '\n', ' ' ),
      ...
      '''The Northern Bald Eagle is a large bird of prey best known for its white head and tail, dark brown body, and powerful yellow
         beak and talons. Juveniles are mottled brown and white and do not develop the iconic white head and tail until about five
         years of age. Adults typically weigh 3–6 kg, with females noticeably larger than males, and have a wingspan of up to 2.4
         metres.'''.replace( '\n', ' ' ),
      ...
      '''Bald Eagles are primarily piscivorous, feeding mainly on fish, but they are also opportunistic hunters and scavengers. Their
         diet may include waterfowl, small mammals, and carrion. At the zoo, they are fed a varied diet of fish and meat, with feeding
         enrichment designed to encourage tearing, grasping, and natural feeding behaviours.'''.replace( '\n', ' ' ),
      ...
      '''These eagles are highly adapted for hunting in cold, aquatic environments. Their keen eyesight allows them to spot prey from
         great distances, while powerful talons provide a secure grip on slippery fish. Broad wings enable efficient soaring and
         gliding, conserving energy during long patrol flights. Dense plumage helps insulate against cold northern climates.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      -40,                                                           # Minimum temperature (only for animals with outdoor viewing)
      5,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The polar bears can be spotted in several habitats in the Tundra Trek exhibit. Coming at the habitat from the side closer to
         Eurasia, you have the maternity yard, the main pool habitat, and the main grass habitat. In the warmer months the bears will
         likely avoid the grass habitat and either spend their time in the pool habitat and the maternity yard in the shade. In the
         cooler months you are more likely to see bears being active in the grass habitat.'''.replace( '\n', ' ' ),
      '''While visible all year-round, the polar bears at the zoo are far more active during the cooler months. During the summer,
         they are quite lethargic, and spend much of their time resting in the shade. If you want to see the polar bears most active,
      ...
      '''Polar Bears are native to the circumpolar Arctic, occurring in Canada, Greenland, Russia, Alaska, and Norway. They are
         ...
         primarily in Hudson Bay, the Arctic Archipelago, and along northern coastlines. As sea ice melts seasonally, many bears move
         onto land during summer months.'''.replace( '\n', ' ' ),
      '''Polar Bears are highly specialised carnivores that rely primarily on seals, especially ringed and bearded seals. They hunt by
         waiting at breathing holes in the ice or stalking seals resting on the ice surface. Their diet is extremely high in fat,
      ...
      '''Polar Bears are mostly solitary, except for females with cubs or during mating season. They have large home ranges and are
         ...
         body language, vocalisations, and scent marking. On land, they may scavenge carcasses or explore coastal areas while waiting
         for sea ice to return.'''.replace( '\n', ' ' ),
      ...
      '''Breeding occurs in spring, but implantation of the fertilised egg is delayed until autumn. Pregnant females enter maternity
         ...
         one kilogram. They remain with their mother for about 2.5 years, learning hunting and survival skills. Polar Bears typically
         live 20–25 years in the wild, with some individuals living longer in captivity.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      0,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The American flamingos are part of the Mayan Temple Ruins exhibit, which is accessed be walking through the Tundra Trek. Once
         you reach the waterfall, walk to the right and you will come upon the flamingos.'''.replace( '\n', ' ' ),
      ...
      '''The American Flamingo is the largest and most vividly coloured of all flamingo species. Adults have bright pink to coral-red
         plumage, long slender legs, and a distinctive downward-curved bill adapted for filter feeding. The bill is pink with a black
         tip, and their legs are typically pink or reddish. Juveniles are greyish with duller colouring, developing their
         characteristic pink plumage over several years.'''.replace( '\n', ' ' ),
      '''American Flamingos are native to the Caribbean, the Galápagos Islands, northern South America, and coastal regions of Central
         America, including the Yucatán Peninsula. They inhabit shallow lagoons, salt flats, mangrove swamps, and coastal wetlands
         where warm, saline or brackish water supports abundant food sources.'''.replace( '\n', ' ' ),
      '''Flamingos are specialised filter feeders, feeding primarily on algae, diatoms, small crustaceans, and aquatic invertebrates.
         Their unique bills work upside down, filtering food from mud and water using comb-like structures called lamellae. Carotenoid
         pigments in their diet are responsible for their pink colouration. At the zoo, American Flamingos are fed a nutritionally
         balanced diet that includes specially formulated pellets and supplements to maintain healthy plumage colour.'''
         .replace( '\n', ' ' ),
      '''American Flamingos are highly social birds that live and breed in large colonies, sometimes numbering in the thousands.
         ...
         communication and breeding. They are monogamous during the breeding season and rely heavily on group cohesion for safety and
         successful reproduction.'''.replace( '\n', ' ' ),
      ...
      '''Breeding occurs in large colonies, often triggered by rainfall and suitable water levels. Flamingos build cone-shaped mud
         nests on raised mounds to protect eggs from flooding. Females typically lay a single egg, which both parents incubate. Chicks
         hatch with grey down and straight bills and are fed nutrient-rich crop milk produced by both parents. Flamingos are 
         ong-lived birds, commonly reaching 30–40 years, with some individuals living even longer in captivity.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Black-handed Spider Monkeys are primarily frugivorous, feeding mainly on ripe fruits. They also consume leaves, flowers,
         seeds, and occasional insects. Their diet changes seasonally based on food availability. At the zoo, they are fed acarefully
         balanced diet of fruits, vegetables, leafy greens, and primate biscuits, with foraging enrichment to encourage natural
         feeding behaviours.'''.replace( '\n', ' ' ),
      ...
      '''Black-handed Spider Monkeys are specialised for an arboreal lifestyle. Their long limbs and hook-like hands allow fast,
         energy-efficient brachiation. The prehensile tail provides strength, balance, and fine motor control, enabling them to hang
         or move while carrying food or infants. Reduced thumbs prevent interference during swinging, making their movement highly
         streamlined.'''.replace( '\n', ' ' ),
      '''Females give birth to a single infant after a gestation period of about 7.5 months. Infants cling to their mother’s belly and
         later ride on her back as they grow. Young monkeys learn social and foraging skills over several years. Black-handed Spider
         Monkeys have a long lifespan, typically 20–25 years, with longer lifespans possible in captivity.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      5,                                                             # Minimum temperature (only for animals with outdoor viewing)
      0,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The capybara is part of the Mayan Temple Ruins exhibit, which is accessed be walking through the Tundra Trek. You should find
         the capybaras at the bottom of the waterfall.'''.replace( '\n', ' ' ),
      ...
      '''Capybaras are herbivorous grazers, feeding primarily on grasses, aquatic plants, and reeds. They have specialized teeth that
         grow continuously to compensate for wear from tough vegetation. At the zoo, their diet includes hay, grasses, leafy greens,
         vegetables, and formulated herbivore pellets to ensure proper nutrition.'''.replace( '\n', ' ' ),
      ...
      '''Capybaras are well adapted to semi-aquatic life. Their partially webbed feet make them strong swimmers, while their ability
         ...
         head enable awareness while in water. Their digestive system efficiently processes fibrous plant material, and they practice
         coprophagy to maximise nutrient absorption.'''.replace( '\n', ' ' ),
      '''Breeding typically occurs during the wet season. Females give birth to litters of 2–8 well-developed young after a gestation
         period of about 150 days. Unlike many rodents, capybara young are born fully furred and begin grazing within days. Capybaras
         generally live 8–10 years in the wild, with longer lifespans possible in captivity.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The American alligator can be found in the Costa Rica loop of the Americas Pavilion, through the doors across from the North
         American river otter viewing, and past the bugs.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The American Alligator is a large, heavily built reptile with a broad snout, powerful jaws, and thick, armour-like skin
         reinforced with bony plates called osteoderms. Adults are dark grey to black in colour, while juveniles display bright yellow
         banding that fades with age. Males are significantly larger than females, with large males exceeding 4 metres in length and
         weighing over 400 kg.'''.replace( '\n', ' ' ),
      ...
      '''Alligators are opportunistic carnivores. Juveniles feed mainly on insects, crustaceans, and small fish, while adults consume
         fish, turtles, birds, mammals, and occasionally carrion. They ambush prey using stealth and explosive speed. In zoos,
         alligators are fed a controlled diet of meat and fish, with feeding schedules designed to mimic natural feast-and-famine
         cycles.'''.replace( '\n', ' ' ),
      '''American Alligators are generally solitary but may tolerate others in favourable habitats. They are most active during warmer
         months and spend much of their time basking to regulate body temperature. Vocal communication is more complex than often
         assumed; adults produce deep bellows during the breeding season, while juveniles emit high-pitched calls to signal distress.
         '''.replace( '\n', ' ' ),
      '''Alligators are superbly adapted to aquatic ambush hunting. Their eyes and nostrils are positioned on top of the head,
         ...
         throat prevents water from entering the lungs while submerged. Their bite force is among the strongest of any living animal,
         enabling them to crush bone and shell.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The American Eel is a long, snake-like fish with a smooth, scaleless appearance and a continuous dorsal, caudal, and anal fin
         that runs along much of its body. Colouration ranges from olive or brownish-yellow in juveniles to dark brown or nearly black
         in mature adults. Despite their resemblance to snakes, they are true fish with gills and fins.'''.replace( '\n', ' ' ),
      ...
      '''American Eels are primarily solitary and nocturnal. During the day, they often hide under rocks, logs, or sediment. They are
         strong swimmers and capable of moving over damp ground, allowing them to bypass obstacles such as small dams or barriers.
         Although generally secretive, they play an important ecological role as both predator and prey.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The American lobster can be found in a tank enclosure in the aquatic section of the Americas Pavilion, after the primate wing
      ...
      '''Lobsters are omnivorous scavengers, feeding on fish, molluscs, crustaceans, worms, algae, and carrion. They play an important
         role in cleaning the ocean floor. At the zoo, lobsters are fed a controlled diet of seafood and plant matter to reflect their
         natural feeding habits.'''.replace( '\n', ' ' ),
      ...
      '''Mating occurs after a female has moulted, when her shell is still soft. Females carry fertilised eggs on their swimmerets for
         up to a year before they hatch into free-swimming larvae. Lobsters grow slowly and may take several years to reach maturity.
         They can live 50 years or more, making them one of the longest-lived marine invertebrates.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Axolotl',
      ...
      '''The Axolotl is a neotenic salamander, meaning it retains its juvenile features throughout its life. It has a broad, flat
         ...
         albino.'''.replace( '\n', ' ' ),
      '''Axolotls are native to high-altitude freshwater lakes and canals in the Valley of Mexico, including Xochimilco. They inhabit
         calm, vegetated waters, often hiding among submerged plants and rocks. They are critically endangered in the wild due to
         habitat loss, pollution, and invasive species.'''.replace( '\n', ' ' ),
      ...
      '''Axolotls are remarkable for retaining gills and remaining fully aquatic throughout life. Their regenerative abilities are
         exceptional, capable of regrowing limbs, spinal cord, heart tissue, and parts of their brain. Their skin secretes protective
         mucus, and their lateral line system detects vibrations and movement in water, aiding hunting and navigation.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The black-footed ferret can be spotted in a small habitat beside the Eastern loggerhead shrike, just before the river otters.
         '''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''These ferrets are obligate carnivores, feeding almost exclusively on prairie dogs. They also eat other small mammals, birds,
         and insects when available. At the zoo, they are fed a diet designed to replicate wild feeding patterns, including specially
         formulated carnivore diets and small prey items.'''.replace( '\n', ' ' ),
      ...
      '''Breeding occurs in late winter or early spring. Females give birth to 3–5 kits after a gestation period of about 42 days,
         ...
         Ferrets live 5–8 years in the wild, and often longer in captivity, with careful husbandry supporting breeding and population
         recovery.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      '''Black Widows are native to much of North America, including Canada, the United States, and Mexico. They inhabit dark,
         undisturbed areas such as rock crevices, hollow logs, sheds, and under debris. They favour warm microhabitats with low human
         disturbance.'''.replace( '\n', ' ' ),
      '''Black Widow Spiders are carnivorous, feeding primarily on insects, other arthropods, and occasionally small vertebrates that
         get trapped in their irregular, sticky webs. They inject venom to immobilize prey before consuming it. In zoo settings, they
         are fed small insects such as crickets and fruit flies to simulate natural feeding.'''.replace( '\n', ' ' ),
      '''Black Widows are generally solitary. Females maintain a territory centred around their web and rarely leave it. Mating is
         risky for males, who may be eaten by the female. Communication is largely vibrational, transmitted through the web to detect
         prey, predators, or mates.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing
      '''The Blanding's turtles can be spotted in a shared habitat with the painted turtles near the exit of the pavilion, and on the
         left.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''Blanding’s Turtles are omnivorous, feeding on a mix of aquatic plants, algae, insects, small fish, crustaceans, and carrion.
         They forage in shallow water and along shorelines. At the zoo, they are provided a balanced diet that includes aquatic
         vegetation, insects, and specially formulated turtle pellets.'''.replace( '\n', ' ' ),
      '''These turtles are primarily solitary and spend much of their time submerged or buried in mud, surfacing to bask in the sun.
         They are most active during spring and summer and hibernate in mud at the bottom of wetlands during winter. Communication is
         limited, mostly involving visual and chemical cues.'''.replace( '\n', ' ' ),
      '''Blanding’s Turtles are well adapted to aquatic and semi-aquatic life. Their domed shells protect them from predators, while
         webbed feet allow efficient swimming. Long necks enable them to snap quickly at prey, and their yellow throat may serve as a
         warning or recognition signal. They hibernate for months in cold Canadian winters, reducing metabolic activity to survive
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Blue Poison Dart Frog is a small, vividly coloured amphibian, measuring around 3–4 cm in length. Its skin is a brilliant
         sky-blue with irregular black spots or marbling. This striking colouration serves as a warning to predators of its toxicity.
         These frogs have slender bodies, long limbs, and sticky pads on their toes for climbing.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The boa constrictor can be found near the start of the pavilion, through the doors past the blue and gold macaws, and then on
         the left and around the corner past the Jamaican boa.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The Boa Constrictor is a large, heavy-bodied snake with a distinctive pattern of dark saddles or bands along its tan, brown,
         or reddish-grey body. Adults typically reach 2–4 metres in length, though some may exceed 5 metres. Their heads are
         triangular, with heat-sensing pits along the upper lip to detect warm-blooded prey.'''.replace( '\n', ' ' ),
      '''Boa Constrictors are native to Central and South America, inhabiting tropical forests, savannas, and semi-arid regions. They
         prefer areas with dense vegetation, tree cover, or rocky crevices, and are often found near water sources.'''
         .replace( '\n', ' ' ),
      ...
      '''Mating occurs in the wet season. Females give birth to live young (viviparous), usually 10–65 per litter, depending on size.
         Juveniles are fully independent at birth and grow steadily. Boa Constrictors can live 20–30 years in captivity with proper
         care.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The Brazilian giant cockroach can be found in the bugs hallway, located before the Costa Rican area through the doors across
         from the river otter viewing.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The butterfly goodeid can be found in an enclosure towards the exit of the pavilion, across from the river otter and snapping
         turtle underwater viewings.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The crested tinamou can be spotted in an enclosure near the entrance to the pavilion, just past the blue and gold macaws and
         straight ahead. The crested tinamou shares a habitat with the plush-crested jays.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''These birds are shy and primarily solitary or in pairs, although small groups may form outside the breeding season. They are
         excellent runners, using speed to evade predators. Flight is short and rapid, used mainly as a last resort. They communicate
         using soft calls and subtle displays, particularly during courtship.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Cuvier’s Smooth-Fronted Caiman is a small to medium-sized crocodilian, typically reaching 1.2–1.5 metres in length as
         ...
         upturned snout. Unlike larger caimans, it has a robust, compact build suited for dense forest streams.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The desert grassland whiptail can be found in an enclosure towards the exit of the pavilion, across from the river otter and
         snapping turtle underwater viewings. The desert grassland whiptail shares a habitat with the San-Esteban Island chuckwalla'''
         .replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''Native to the southwestern United States and northern Mexico, this species inhabits desert grasslands, scrublands, and
         semi-arid regions. It prefers open areas with sandy soil and sparse vegetation that allow quick movement and easy sunbathing
         for thermoregulation.'''.replace( '\n', ' ' ),
      ...
      '''The Desert Grassland Whiptail has several adaptations for survival in arid environments. Its long, powerful legs allow rapid
         sprints to catch prey and avoid predators. Its striped pattern provides camouflage among grasses and sandy soil. Uniquely,
         many populations are all-female and reproduce through parthenogenesis, producing genetically identical offspring without
         males.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''These frogs are diurnal and territorial. Males establish and defend territories through calls and displays, often near water
         or breeding sites. They exhibit complex courtship behaviours, including following, tapping, and vocalisations. Social
   ...
   (
      ...
      '''The Eastern Loggerhead Shrike is a small to medium-sized songbird, measuring about 22–26 cm in length with a wingspan of
         30–35 cm. It has grey upperparts, a white underside, black wings with white patches, and a distinctive black mask across the
         eyes. Its hooked beak is strong and curved, ideal for catching and killing prey.'''.replace( '\n', ' ' ),
      '''This subspecies of Loggerhead Shrike inhabits open grasslands, agricultural fields, and savannas across eastern North
         ...
         .replace( '\n', ' ' ),
      '''Eastern Loggerhead Shrikes are carnivorous, feeding on insects, small birds, rodents, and reptiles. They are known for their
         unique behaviour of impaling prey on thorns, barbed wire, or sharp branches to tear it into manageable pieces. In zoos, they
         are fed insects, small rodents, and other appropriately sized prey to replicate natural feeding.'''.replace( '\n', ' ' ),
      '''Shrikes are solitary hunters, perching silently to spot prey before swooping down for capture. They are territorial and may
         use vocal calls and displays to defend their territory. Social interaction outside breeding is limited. Their striking black
         mask and vocalisations are key elements of communication.'''.replace( '\n', ' ' ),
      ...
      '''Breeding occurs in spring. Females lay 4–7 eggs in well-hidden cup-shaped nests in shrubs or small trees. Both parents
         participate in feeding chicks, which fledge after about 2–3 weeks. Loggerhead Shrikes typically live 9–12 years in the wild,
         with slightly longer lifespans in captivity.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
   ...
   (
      ...
      '''Eyelash Vipers are ambush predators, feeding primarily on small birds, frogs, lizards, and occasionally rodents. They strike
         rapidly and inject hemotoxic venom to immobilize prey. In captivity, they are typically fed appropriately sized mice or
         small amphibians, depending on the individual’s size.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      0,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The golden lion tamarins have an indoor viewable habitat, and an outdoor viewable habitat. Theeir outdoor viewing is located
         right near the David C. Onley Boardwalk, which connects the Americas to Africa. If you don't see the monkeys in any of these
   ...
   ( # Also in Kids Zoo
      ...
      -20,                                                           # Minimum temperature (only for animals with outdoor viewing)
      5,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The great horned owl can be seen in the Americas, and in the Kids Zoo. In the Americas, the owl can be seen just outside the
         pavilion, to the right of the doors.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Green and Black Poison Dart Frog is a small, vibrantly coloured amphibian, typically 3–4 cm long. Its body is black with
         striking green, blue, or turquoise irregular spots or bands, giving it a marbled appearance. Its smooth skin contains potent
         toxins in the wild, serving as a warning to predators.'''.replace( '\n', ' ' ),
      '''Native to Central and South America, especially Costa Rica, Panama, and northern Colombia, these frogs inhabit humid lowland
         rainforests, forest edges, and shaded areas near streams and pools. They prefer dense vegetation that provides shelter and
         breeding sites.'''.replace( '\n', ' ' ),
      '''Green and Black Poison Dart Frogs are insectivorous, feeding on ants, termites, mites, and small invertebrates. In captivity,
         they are provided small insects such as fruit flies, springtails, and pinhead crickets to replicate their natural diet and
         maintain vibrant colouration.'''.replace( '\n', ' ' ),
      ...
      '''Bright aposematic colouration warns predators of their toxicity. They have adhesive toe pads for climbing leaves, moss, and
         stems, and sensitive skin that absorbs moisture and environmental cues. Their small size and agility allow efficient hunting
         of tiny arthropods and rapid evasion from predators.'''.replace( '\n', ' ' ),
      '''Breeding occurs year-round in suitable humid environments. Females lay 5–15 eggs on moist surfaces, often under leaves.
         Males transport tadpoles to small pools or bromeliad axils for development. Tadpoles metamorphose into juvenile frogs within
         several weeks. Lifespan is generally 5–8 years, with longer lifespans in captivity under optimal care.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Green Surf Anemone',
      ...
      '''The Green Surf Anemone is a large, striking sea anemone with a broad, flattened body and numerous short tentacles 
         ...
         diameter.'''.replace( '\n', ' ' ),
      '''This species is found along the Pacific coast of North America, from Alaska to Baja California. It inhabits rocky intertidal
         zones, tide pools, and wave-exposed shorelines where it firmly attaches to rocks. Green Surf Anemones thrive in areas with
         strong water movement and changing tidal conditions.'''.replace( '\n', ' ' ),
      ...
      '''Although stationary, these anemones are highly responsive to their environment. They retract their tentacles when threatened
         or exposed to air and can slowly relocate if conditions become unfavourable. They play an important ecological role in
         intertidal communities by regulating small invertebrate populations and providing shelter for commensal species'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The green-winged macaws can be found near the beginning of the pavilion, just through the doors past the blue and gold macaws
         and on the right.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''This species is native to the tropical forests of Central and South America, including the Amazon Basin. It inhabits lowland
         rainforests, river edges, swamp forests, and palm groves, where tall trees provide nesting sites and abundant food.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The Guatemalan beaded lizards can be found in an enclosure towards the exit of the pavilion, across from the river otter and
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Jamaican Boa is a large, muscular snake with a yellowish-brown to olive body marked by dark blotches along its back. Its
         colouration varies with age, with juveniles often showing stronger contrast than adults. The head is broad and distinct from
         the neck, and the eyes are relatively large, reflecting its partially arboreal lifestyle. Adults typically reach 1.5–2.3
         metres in length.'''.replace( '\n', ' ' ),
      ...
      '''Jamaican Boas are carnivorous constrictors that feed on birds, bats, rodents, and occasionally lizards. They ambush prey and
         kill by constriction. Young boas primarily eat small lizards and frogs before transitioning to larger prey as they grow. In
         zoos, they are fed appropriately sized rodents and birds.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''This species is found along the Pacific coast of North America, from Alaska to California. It inhabits rocky subtidal zones,
         kelp forests, and tide pools, usually at depths from the low intertidal to deeper coastal waters. Leather Sea Stars prefer
         areas with strong water movement and abundant prey.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Lemur Leaf Frog is a small to medium-sized tree frog with smooth skin and a slender body. It is typically light green
         with subtle yellow or cream markings on the flanks and limbs. Large eyes and long legs give it a delicate appearance. Adults
         usually reach 4–6 cm in length, with females slightly larger than males.'''.replace( '\n', ' ' ),
      ...
      '''Lemur Leaf Frogs are insectivorous, feeding on small insects such as crickets, flies, moths, and beetles. They hunt at night,
         using their agility and vision to capture prey among leaves and branches. In zoos, they are fed appropriately sized insects
         dusted with vitamins and minerals.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Heat-sensing pits between the eyes and nostrils allow detection of warm-blooded prey even in low light. The rattle serves as
         an effective warning system to deter large animals. Cryptic colouration helps the snake blend into its surroundings,
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The midland painted turtle can be spotted in a shared habitat with the Blanding's turtles near the exit of the pavilion, and
         on the left.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The Midland Painted Turtle is a small to medium-sized freshwater turtle, with a smooth, domed shell that is olive to dark
         brown on top and brightly patterned with red, yellow, and black markings on the plastron and edges. Adults typically measure
         12–20 cm in length. Its head, legs, and tail also feature yellow stripes.'''.replace( '\n', ' ' ),
      ...
      '''Midland Painted Turtles are omnivorous. Their diet includes aquatic plants, algae, insects, crustaceans, tadpoles, and small
         fish. They forage both in water and along shorelines. In captivity, they are fed a balanced diet of leafy greens, aquatic
         vegetation, insects, and commercial turtle foods.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The North American river otters can be seen from two main spots. You can see them from above, just past the entrance to the
         pavilion, or venture inside the pavilion, heading past the aquatic area to see them underwater, or inside. The North American
         river otters are a highly active species, and can be usually seen swimming around their water feature during the day. If you
         don't spot them playing in the water, they may be taking a rest, either in their indoor habitat, or in one of their toys in
         their outdoor habitat.'''.replace( '\n', ' ' ),
      '''North American otters can be outside and in the water year-round, but they are always given the option to stay inside, so you
         may have to venture inside the pavilion to see them.'''.replace( '\n', ' ' ),
      '''The North American River Otter is a medium-sized aquatic mammal with a streamlined body, short legs, and a thick, muscular
         tail. Adults typically measure 66–107 cm in body length, with tails adding another 30–45 cm, and weigh 5–14 kg. Fur is dense,
         velvety, and dark brown on the back, fading to lighter brown on the underside. Whiskers, webbed feet, and a flattened head
         help with hunting and swimming.'''.replace( '\n', ' ' ),
      ...
      '''North American River Otters are opportunistic carnivores, feeding primarily on fish, crayfish, amphibians, molluscs, and
         small mammals. They occasionally eat birds or aquatic insects. They are skilled hunters, using sharp teeth, strong jaws, and
         webbed feet to catch and handle slippery prey. In zoos, they are provided with fish, crustaceans, and enrichment to mimic
         natural hunting behaviour.'''.replace( '\n', ' ' ),
      ...
      '''The Toronto Zoo is home to a pair of North American river otters, a younger female Maybelle, and an older male, RJ. Maybelle
         arrived from the Calgary Zoo as a companion for RJ. They can often be spotted swimming around together, but if you see one
         otter being active, and the other not, it is likely that RJ is the one needing a rest.'''.replace( '\n', ' ' )
   ),
   (
      'Opal-Rumped Tanager',
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      ...
      None,                                                          # Seasonal viewing tips
      '''The Opal-rumped Tanager is a small, colourful songbird, about 13 cm long. Its body is mostly bright green with striking blue
         wings and tail, while the lower back and rump shimmer with an opalescent bluish-purple sheen. Its short, pointed beak is
         well suited for eating fruit and insects.'''.replace( '\n', ' ' ),
      ...
      '''These tanagers are social, often found in small flocks or mixed-species foraging groups. They communicate with high-pitched
         ...
         .replace( '\n', ' ' ),
      '''Bright plumage aids in species recognition and courtship, while their lightweight bodies and strong wings allow rapid flight
         through dense vegetation. Their short, pointed beak is effective for both fruit consumption and insect hunting. Social
         flocking helps reduce predation risk and increases foraging efficiency.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The painted anemone can be found in a tank enclosure in the aquatic section of the Americas Pavilion, after the primate wing
         and before the otters and Costa Rican area.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The Painted Anemone is a large, colourful sea anemone with a cylindrical body and a crown of tentacles surrounding a central
         mouth. Colours vary from red, pink, orange, or purple, often with contrasting tentacle tips. Individuals typically reach
         15–25 cm in diameter, though tentacles can extend further.'''.replace( '\n', ' ' ),
      ...
      '''Tentacles equipped with nematocysts allow efficient capture and immobilisation of prey. Their sticky base firmly attaches to
         substrates to resist wave action. Bright and varied colours may deter predators and signal toxicity. Ability to retract
   ...
   (
      ...
      '''These frogs are diurnal and highly social, often communicating through visual signals such as leg-waving displays, which
         serve as territorial and courtship signals. They are active hunters during the day and are known for their agile jumping and
         climbing abilities. Their bright colouration helps individuals recognise each other while warning predators.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The plumose anemone can be found in a tank enclosure in the aquatic section of the Americas Pavilion, after the primate wing
         and before the otters and Costa Rican area.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''Plumose Anemones are sessile and generally solitary but may cluster in areas with abundant food. They extend their tentacles
         to capture passing prey and retract them when disturbed. While they do not actively move, they can slowly detach and drift
         to a new location if necessary.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Plush-Crested Jays are omnivorous, feeding on fruits, seeds, insects, small vertebrates, and occasionally eggs of other
         birds. They forage actively in trees and shrubs, using their strong beaks to probe for insects and manipulate food. In zoos,
         they are provided with a balanced diet of fruits, insects, and supplemental bird feed.'''.replace( '\n', ' ' ),
      ...
      '''Breeding occurs during the wet season. Nests are constructed high in trees, and females typically lay 2–5 eggs. Both parents
         participate in incubation and feeding of hatchlings. Juveniles are independent after several weeks. Lifespan in the wild is
         typically 8–10 years, with longer lifespans possible in captivity.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Puerto Rican Crested Toad is a small, stout amphibian, typically 3–5 cm in length. Its body is grey to brown with darker
         blotches, and it has distinctive raised crests over the eyes. The skin is rough and slightly warty, adapted for a
      ...
      '''This species is endemic to Puerto Rico, inhabiting dry forests, coastal plains, and intermittent freshwater pools. It
         ...
         .replace( '\n', ' ' ),
      '''Puerto Rican Crested Toads are insectivorous, feeding on ants, beetles, spiders, and other small invertebrates. They hunt at
         night, capturing prey with their sticky tongues. In zoos, their diet includes appropriately sized insects dusted with
      ...
      '''Raised cranial crests may deter predators or help shed water during rainfall. Burrowing behaviour allows them to survive dry
         periods and avoid predators. Their skin colouration and patterning provide camouflage in leaf litter and soil.'''
         .replace( '\n', ' ' ),
      '''Breeding occurs during the rainy season when temporary pools form. Females lay eggs in water, and tadpoles develop rapidly
         to take advantage of ephemeral habitats. Juveniles are independent upon metamorphosis. Lifespan is typically 5–8 years, with
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The Red Island bird-eating tarantula can be found in the bugs hallway, located before the Costa Rican area through the doors
         across from the river otter viewing.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The Rufous-Collared Sparrow is a small songbird, typically 13–15 cm in length. It has a grey head with a rufous collar around
         the neck, brown streaked upperparts, and pale underparts with subtle streaking. The short, conical beak is ideal for seed
         consumption, and the species is known for its melodious, variable song.'''.replace( '\n', ' ' ),
      '''This species is widespread throughout Central and South America, from Mexico to Tierra del Fuego. It inhabits open woodlands,
         farmland, gardens, and urban areas. Rufous-Collared Sparrows are highly adaptable and can thrive in both lowland and
         highland regions up to 4,000 m.'''.replace( '\n', ' ' ),
      ...
      '''These sparrows are diurnal and social, often seen in pairs or small flocks. They communicate through complex songs and calls,
         which play roles in mate attraction and territorial defence. Active foragers, they hop on the ground and make short flights
         while searching for food.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The San-Esteban Island  huckwalla can be found in an enclosure towards the exit of the pavilion, across from the river otter
         and snapping turtle underwater viewings. The San-Esteban Island Chuckwalla shares a habitat with the desert grassland
         whiptail.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''This species is endemic to San Esteban Island in the Gulf of California, Mexico. It inhabits rocky, arid landscapes with
         ...
         .replace( '\n', ' ' ),
      '''Chuckwallas are primarily herbivorous, feeding on leaves, flowers, fruits, and occasionally seeds of desert plants. They are
         active during the day, foraging among rocks and shrubs. In captivity, their diet is supplemented with leafy greens,
   ...
   (
      ...
      '''Flattened, disc-shaped bodies and pectoral fins allow efficient movement along the riverbed. Sensory pits and
         electroreception detect hidden prey. Camouflaged colouration provides protection from predators, and the venomous tail spine
         deters threats. Mouths located on the underside facilitate bottom feeding.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Spotted Turtles inhabit shallow freshwater wetlands, marshes, ponds, and slow-moving streams in the eastern United States
         and southern Canada. They prefer areas with soft mud, abundant aquatic vegetation, and access to basking sites like logs or
         rocks.'''.replace( '\n', ' ' ),
      '''These turtles are omnivorous, feeding on aquatic invertebrates, small fish, carrion, and plant matter. They forage along the
         bottom and among vegetation, using their sharp beak to grasp prey. In zoos, they are fed a combination of insects, worms,
         aquatic plants, and commercially prepared turtle food.'''.replace( '\n', ' ' ),
      '''Spotted Turtles are generally solitary but may share basking sites. They are diurnal, spending much of the day foraging,
         basking, and swimming. During cold weather, they hibernate in mud or underwater. Males and females interact primarily during
         the breeding season.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Breeding occurs during the rainy season when food is abundant. Females build cup-shaped nests in shrubs or low trees and lay
         2–3 eggs. Both parents participate in feeding and caring for the young until fledging. Lifespan is typically 5–8 years in
         the wild, with longer lifespans in captivity.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Two-Toed Sloth',
      ...
      '''The two-toed sloth is endemic to the rainforests of South America, and is suited to be outside in the warm weather. You have
         a good chance of spotting them outside through May into September, with a chance as well on warm days in April or October.
         Even on warm days, the sloths opt to spend their time inside. During the cooler months, they can exclusively be spotted
         inside.'''.replace( '\n', ' ' ),
      '''The Two-Toed Sloth is a medium-sized arboreal mammal, measuring 50–70 cm in body length and weighing between 4 and 8 kg. Its
         coarse, greyish-brown fur often hosts algae, which provides natural camouflage in the canopy. The species is named for the
         two long, curved claws on each forelimb, which allow it to grasp branches securely while hanging upside down. Its face is
         round with dark markings around the eyes, giving it a mask-like appearance, and its overall body structure is adapted for a
         slow, deliberate lifestyle.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Western blacknose dace can be found in an enclosure towards the exit of the pavilion, across from the river otter and
         snapping turtle underwater viewings.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The Western Blacknose Dace is a small freshwater fish, typically 5–10 cm in length, with a slender, elongated body. Its back
         is olive-brown, fading to silvery sides and a pale underside. A distinctive dark stripe runs from the nose to the tail along
         each side, giving the species its name. The fins are generally transparent, and the mouth is slightly downturned, suited for
         bottom feeding.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''White-Faced Sakis breed year-round, with females giving birth to a single infant after a gestation of about 150–180 days.
         Offspring cling to their mother’s belly for several weeks before riding on her back. Juveniles gradually learn to forage and
         move independently. Sexual maturity occurs around 3–4 years, and individuals can live 15–25 years in the wild, often longer
         in captivity due to veterinary care and consistent nutrition.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Yellow-Banded Poison Dart Frogs are carnivorous, feeding primarily on small invertebrates such as ants, termites, and mites.
         Their diet in the wild contributes to the production of skin toxins, which serve as chemical defences against predators. In
         zoos, they are fed tiny insects like fruit flies, springtails, and pinhead crickets to mimic natural feeding and support
         healthy growth.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      -20,                                                           # Minimum temperature (only for animals with outdoor viewing)
      4,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The cougars can be spotted by heading partway down the hill of the Canadian domain exhibit. A bit more than halfway down the
         hill, and across from the male wood bison paddock you will find the cougars.'''.replace( '\n', ' ' ),
      '''Cougars are well-adapted to the cold and can stay outside all through the winter. If the domain is open then the cougars
         should be viewable. The cougars at the zoo have access to a behind-the-scenes indoor habitat which they often spend time in.
         The cougars are fairly interested in zoo guests, and thus if you don't see them right away, but wait for a few minutes, you
         may get a close encounter with one of them. Also be sure to check for them inside their cave in the back right corner of the
         habitat, on top of all of the platforms, and along the fence on the left side of the exhibit.'''.replace( '\n', ' ' ),
      ...
      '''Cougars are obligate carnivores and ambush predators, feeding primarily on deer, elk, and smaller mammals such as rabbits or
         rodents. They rely on stealth, patience, and powerful bursts of speed to capture prey. In zoos, cougars are fed a diet of
         meat that mimics their natural intake, including whole prey items or meat supplemented with vitamins and minerals.'''
         .replace( '\n', ' ' ),
      '''Cougars are solitary, territorial animals, with males defending large territories that may overlap with several females.
         They are mostly nocturnal or crepuscular, becoming more active at dawn and dusk. Cougars communicate through scent markings,
         vocalisations such as growls or screams, and visual cues. Despite their size and power, they are generally elusive and
         rarely seen in the wild.'''.replace( '\n', ' ' ),
      '''Cougars have evolved for stealth and power. Their muscular bodies and long limbs allow them to leap great distances and
         ...
         while keen eyesight and hearing aid hunting in low-light conditions. Their large home ranges reflect their need to track and
         secure sufficient food, and solitary behaviour reduces competition for resources.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The grizzly bear is viewable seasonably due to its hibernating patterns. Grizzly bears hibernate from sometime in November,
         ...
         more of their time resting off-display. The grizzly bear can usually be spotted on exhibit from April through October. The
         grizzly bear at the Toronto Zoo, Shintay, is in her golden years and may choose to spend some of her time behind the scenes.
         She can often be seen resting in the shade near the viewing areas of the exhibit, or by peering through the bars into her
         behind-the-scenes area. She is most active during wild encounters, where she will forage around her habitat, enjoying a
         variety of foods which she retrieves by performing enrichment activities.'''.replace( '\n', ' ' ),
      '''The Grizzly Bear is a large, powerful bear, with adult males weighing 270–360 kg and females 130–200 kg. They stand 1–1.5 m
         ...
         .replace( '\n', ' ' ),
      '''Grizzly Bears are native to North America, inhabiting forests, alpine meadows, tundra edges, and river valleys, primarily in
         Canada, Alaska, and parts of the northwestern United States. They require large territories to support their omnivorous
   ...
   (
      ...
      '''The Wood Bison is a massive, muscular herbivore, with adult males weighing 450–900 kg and females 320–540 kg. They stand
         ...
         fur, large heads, and pronounced shoulder humps distinguish them from plains bison. Both sexes have short, curved horns used
         for defense and social interactions.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''You will find the African lions by taking the Africa Savanna loop. The lions are between the baboons and zebras, and eland
         and hyenas. There is a cave that has glass viewing into the lion habitat, as well as open-air viewings on either side of the
         cave. The lions can most often be seen from the open-air viewing across from the elands. The lions are one of the most 
      ...
      '''The African lions are more or less viewable year round. During the den of winter they are given access to indoor spaces so
         ...
         or fall.'''.replace( '\n', ' ' ),
      '''LThe African Lion is a large, muscular cat, with males weighing 150–250 kg and females 120–182 kg. Males are distinguished
         by their impressive manes, which vary in colour from golden to dark brown, while females lack manes and are slightly smaller
         and more agile. Lions have powerful legs, retractable claws, and sharp teeth adapted for killing large prey. Their tawny
         coats provide camouflage in the dry savanna grasslands, and their expressive faces, including a short, rounded muzzle, are
         instantly recognizable.'''.replace( '\n', ' ' ),
      ...
      '''Lions are highly adapted for life as top predators in the savanna. Their muscular bodies, retractable claws, and strong jaws
         allow them to capture and subdue large prey. Their tawny colouration blends with dry grass, aiding in stealth, while social
         hunting increases success rates. Sharp senses of sight, smell, and hearing help detect prey and rivals over long distances.
         Male manes provide protection during fights and may signal strength to rivals and potential mates. Lions’ endurance and
         cooperative strategies make them effective hunters and dominant apex predators.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''African penguins are adapted to handle temperate climates, and thus can be seen outdoors for most of the year. They should be
         viewable on any day between April and November where the temperature is above 0°C and there is no snow on the ground. They
         may additionally be viewable on some days in March. During the coldest months they can be seen exclusively in their indoor
         habitat.'''.replace( '\n', ' ' ),
      ...
      '''African Penguins are native to the southwestern coasts of Africa, primarily South Africa and Namibia. They inhabit rocky
         islands, coastal beaches, and guano-covered areas where they nest in burrows, under shrubs, or in man-made structures. These
         penguins are highly social, forming large breeding colonies and relying on the nearby ocean for foraging.'''
         .replace( '\n', ' ' ),
      '''These penguins are carnivorous, feeding almost exclusively on small fish such as anchovies and sardines, and occasionally
         squid or crustaceans. They are excellent swimmers and divers, capable of reaching depths of 130 m and speeds up to 20 km/h to
         catch prey. In zoos, they are fed fresh fish diets that mimic natural intake, and enrichment activities encourage diving and
         foraging behaviours.'''.replace( '\n', ' ' ),
      '''African Penguins are highly social, forming large colonies that facilitate breeding and protection against predators. They
         ...
         elaborate displays, including head bowing and preening. Penguins are monogamous for a breeding season, and both parents share
         responsibilities in incubating eggs and feeding chicks.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      -10,                                                           # Minimum temperature (only for animals with outdoor viewing)
      3,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The cheetahs can be seen on the Africa Savanna loop, between the white rhinos and baboons, and across from the zeberas. Most
         of the time, the cheetahs can be seen in the back right part of their enclosure. Look for a head just past the trees. Your
      ...
      '''The Cheetah is a slender, long-legged cat built for speed, weighing 34–56 kg and measuring up to 2.3 m in total length,
         including the tail. Its tan coat is covered in solid black spots, and distinctive black “tear marks” run from the eyes to the
         mouth. Unlike other big cats, cheetahs have a smaller head, lightweight frame, long tail for balance, and semi-retractable
         claws that provide traction during high-speed chases.'''.replace( '\n', ' ' ),
      '''Cheetahs inhabit open savannas, grasslands, and semi-arid regions of sub-Saharan Africa, with a small, critically endangered
         population in Iran. They prefer open habitats where their speed can be fully utilized and where visibility allows them to
         spot prey from a distance. Their range has declined dramatically due to habitat loss, human conflict, and competition with
         other large predators.'''.replace( '\n', ' ' ),
      '''Cheetahs are carnivorous and specialize in hunting medium-sized antelope such as gazelles and impala. Hunts rely on daylight
         vision, stealthy approaches, and explosive sprints rather than ambush or strength. After a successful chase, cheetahs must
         rest before eating due to extreme physical exertion. In zoos, they are fed a carefully managed meat-based diet, often with
         enrichment that encourages stalking or running behaviours.'''.replace( '\n', ' ' ),
      '''Unlike most cats, cheetahs display unique social patterns. Females are solitary except when raising cubs, while males may
         form lifelong coalitions, often with brothers. Cheetahs are primarily diurnal, reducing competition with nocturnal predators
         like lions and hyenas. They communicate using chirps, purrs, and body postures rather than roars.'''.replace( '\n', ' ' ),
      ...
      '''Females give birth to 2–6 cubs after a gestation of about 90–95 days. Cubs are born with a mantle of long grey fur along
         their backs, which may provide camouflage or mimic the appearance of honey badgers. Mortality rates are high in the wild due
         to predation. Cheetahs reach sexual maturity around 2–3 years and typically live 10–12 years in the wild, with longer
   ...
   (
      ...
      '''The Common Eland is the largest species of antelope, with adult males weighing up to 900 kg and females up to 600 kg. They
         stand around 1.6–1.8 m at the shoulder and have a heavy, robust build. Their coat ranges from tan to light brown, often with
         faint white vertical stripes along the sides. Both males and females possess long, spiralled horns, which are thicker and
         more tightly coiled in males. A loose fold of skin, or dewlap, hangs from the throat, especially pronounced in males.'''
         .replace( '\n', ' ' ),
      ...
      '''Breeding typically peaks after the rainy season when food is abundant. Females give birth to a single calf after a gestation
         period of about 9 months. Calves are hidden for the first few weeks of life and then gradually introduced to the herd.
         Sexual maturity is reached around 2–3 years. Common Eland can live 15–20 years in the wild and longer in captivity.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Greater Kudu is a large, slender antelope known for its impressive spiral horns, which are found only in males and can
         ...
         6–10 vertical white stripes along the sides, and a white chevron between the eyes. Large ears provide excellent hearing, and
         their long legs and narrow build give them a graceful appearance.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      0,                                                             # Minimum temperature (only for animals with outdoor viewing)
      2,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The Grevy's zebra habitat is found on the Africa Savanna loop, across from the cheetahs. The zebra enclosure is very long and
         has a very different viewing points. The best spot to see them is usually across from the glass viewing area from which the
         cheetahs and baboons can both be seen. The zebras tend to move across their habitat quite a lot as they graze, so you may
         have to wait for them to come your way to get the best view.'''.replace( '\n', ' ' ),
      ...
      '''Grevy’s Zebras are native to arid and semi-arid regions of northern Kenya and southern Ethiopia. They inhabit dry grasslands,
         savannas, and open plains where vegetation is sparse and water sources are widely spaced. Unlike other zebras, they are
         highly adapted to dry environments and can travel long distances to access water during droughts.'''.replace( '\n', ' ' ),
      ...
      '''Grevy’s Zebras possess several adaptations for survival in hot, dry environments. Their narrow stripes may help regulate
         ...
         movement allow them to travel great distances between grazing areas and water sources. Their ability to digest tough grasses
         gives them a competitive advantage in arid landscapes where food quality is poor.'''.replace( '\n', ' ' ),
      '''Breeding can occur year-round, though births often peak during periods of increased rainfall. Females give birth to a single
         foal after a gestation of approximately 13 months. Foals are able to stand and walk shortly after birth and rely heavily on
         their mother’s protection. Sexual maturity is reached around 3–4 years. Grevy’s Zebras can live 18–25 years in the wild and
         longer in captivity.'''.replace( '\n', ' ' ),
   ...
   ( # Also in Kids Zoo
      ...
      '''Primarily scavengers, Marabou Storks feed on carrion left behind by large predators such as lions and hyenas. They also hunt
         live prey, including fish, frogs, insects, small mammals, and reptiles. Their bald head helps keep them clean while feeding
         inside carcasses, reducing the spread of bacteria.'''.replace( '\n', ' ' ),
      ...
      '''The bald head and neck prevent feathers from becoming fouled during scavenging. Their powerful bill is capable of tearing
         flesh and capturing prey. Large wings allow efficient soaring, conserving energy while covering great distances in search of
         food. The throat pouch may play a role in display and temperature regulation.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Masai giraffe enclosure can be found near the start or end of the Africa Savanna loop, across from the entrance to the
         African Rainforest Pavilion near the lemurs. One of the viewings of the giraffes' outdoor habitat is located up the elevated
         pathway behind the hippo habitat.'''.replace( '\n', ' ' ),
      ...
      '''The Masai giraffe is the tallest land animal on Earth, instantly recognizable by its towering height and bold, irregular
         star-shaped patches. These patches are darker and more jagged than those of other giraffe subspecies, with uneven edges that
         resemble vine leaves. Adults typically stand 4.5–5.7 m (15–18.7 ft) tall, with males heavier and slightly taller than
      ...
      '''Masai giraffes are specialized browsers, feeding primarily on leaves, flowers, and seed pods from tall trees, especially
         ...
         of its water from food and often going days without drinking. Their height allows them access to food sources unavailable to
         other herbivores, reducing direct competition.'''.replace( '\n', ' ' ),
      ...
      '''The Masai giraffe’s body is a masterclass in extreme specialization. Its neck contains only seven vertebrae, the same number
         as most mammals, but each is greatly elongated. A powerful heart weighing up to 11 kg generates high blood pressure to pump
         blood to the brain, while a complex system of valves and elastic blood vessels prevents dangerous pressure changes when the
         giraffe lowers or raises its head. Their long legs provide both height and speed, allowing giraffes to run up to 60 km/h
         (37 mph) over short distances. Thick skin on the legs helps protect against kicks from predators, while large eyes and
         elevated vantage points allow early detection of danger across open landscapes.'''.replace( '\n', ' ' ),
      ...
      '''The Toronto Zoo is home to one female Masai giraffe, Mstari, who is currently pregnant. She is expected to give birth
         sometime from late February to late March. Giraffes' gestation period is around 15 months, and when they give birth, they do
         so standing up with the calves dropping right to the ground. Newborn giraffes are already around 6 ft in height.'''
         .replace( '\n', ' ' )
   ),
   (
      'Olive Baboon',
      ...
      '''The olive baboon is a large, powerfully built monkey with a dog-like muzzle, heavy brow ridge, and long limbs adapted for
         ...
         colouration. Males are substantially larger than females and possess prominent canine teeth and a mane of longer hair around
         the shoulders. Adults typically measure 50–70 cm in body length, with males weighing up to 30 kg, making them among the
         largest monkey species in Africa.'''.replace( '\n', ' ' ),
      '''Olive baboons have the widest distribution of any baboon, occurring across much of central and eastern Africa, from savannas
         and open woodlands to forest edges and even rocky semi-desert. Their adaptability allows them to live near human
      ...
      '''Olive baboons are highly opportunistic omnivores, with diets that change seasonally and regionally. They feed on fruits,
         seeds, leaves, roots, and grasses, as well as insects, eggs, and small vertebrates. Baboons are skilled diggers, using their
         hands to uncover underground tubers and corms during dry periods. Their dietary flexibility is a key reason for their
   ...
   (
      ...
      '''Ostriches are quite adaptive birds, comfortable in temperatures down to around 0°C. They can be fairly reliably seen between
         Apirl and November, and other non-freezing days where there is not much snow on the ground.'''.replace( '\n', ' ' ),
      ...
      '''The ostrich is a masterpiece of evolutionary specialization for life on the open savanna. Its long, muscular legs allow it
         to run at speeds of up to 70 km/h, making it the fastest bird on land. Each foot has only two toes, a unique adaptation that
         reduces weight and improves running efficiency. Powerful legs also serve as formidable weapons, capable of delivering kicks
         strong enough to deter or injure large predators. Large eyes—among the biggest of any land animal—provide excellent
   ...
   (
      ...
      '''Hippos are exquisitely adapted for a semi-aquatic lifestyle. Their eyes, ears, and nostrils are positioned on top of the
         head, allowing them to see, hear, and breathe while mostly submerged. Their skin secretes hipposudoric acid, which functions
         as both sunscreen and antibacterial barrier. Massive jaws and tusks are used for defense and social dominance, while webbed
         feet aid in movement through water. Despite being poor swimmers, they can walk along riverbeds and hold their breath
         underwater for up to 5 minutes. Their unique physiology allows them to tolerate high body temperatures and low oxygen
         conditions during extended submersion.'''.replace( '\n', ' ' ),
      '''Hippos reach sexual maturity at 7–9 years for females and 9–12 years for males. Breeding occurs in water, where males defend
         territories and mate with females in their pods. Females give birth to usually a single calf, often in water, after a
         gestation period of 8 months. Calves can weigh 45–50 kg at birth and are able to swim almost immediately, staying close to
         their mother for protection. River hippos can live 40–50 years in the wild and sometimes longer in managed care.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''Southern ground hornbills can be spotted in two habitats in the Africa Savanna. Some of the hornbills share a habitat with
         the kudus and other savanna birds. They can be viewed in this habitat from any of the three viewings: the savanna outlook in
         the African Rainforest Pavilion near the meerkats, on the offshoot path between the rhinos and hippos, or in the main
         viewing across from the white rhinos, but they may be most reliably seen at the viewing on the offshoot path. The other spot
         that they can be viewed is in the small enclosure between the lions and hyenas, and across from the elands.'''
         .replace( '\n', ' ' ),
      ...
      '''These hornbills are primarily terrestrial foragers, hunting small vertebrates such as lizards, snakes, frogs, and insects.
         They also eat seeds and fruits opportunistically. Using their strong bills, they dig, probe, and capture prey on the ground.
         In zoo care, they are provided a diet of meat, insects, and fruits to replicate their natural nutritional requirements.'''
         .replace( '\n', ' ' ),
      ...
      '''Southern Ground Hornbills are specialized for ground foraging, with strong legs and large feet adapted for walking long
         distances and digging for prey. Their massive bills allow them to handle tough prey and dig efficiently. The bright red skin
         may function in visual communication, signaling age, sex, and social status. Their long lifespan and slow reproduction rate
         are offset by strong family cooperation, helping ensure survival of young in predator-rich environments.'''
         .replace( '\n', ' ' ),
      '''Breeding is slow and cooperative. The dominant female lays 1–3 eggs in tree cavities, but usually only one chick survives to
         fledging. Incubation lasts about 40 days, and both parents and helpers feed the chick. Juveniles remain in the family group
         for several years before dispersing. Southern Ground Hornbills are long-lived, with a lifespan of 50–60 years in the wild,
         making them one of the longest-lived bird species in Africa.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      '''Southern white rhinoceroses are warm-weather animals and have exposed skin, and are only viewable outside during the warmer
         ...
         .replace( '\n', ' ' ),
      '''The Southern White Rhino is a massive herbivore, with adult males weighing 2,000–2,300 kg and females 1,400–1,700 kg, making
         it the second-largest land mammal after elephants (though no elephants are at Toronto Zoo). They measure 3.4–4.2 m in length
         and stand 1.8–2 m at the shoulder. White rhinos have a wide, square-shaped mouth adapted for grazing, and two horns on the
         snout, with the front horn typically 60–150 cm long. Their skin is thick and gray, forming deep folds that provide
         protection and flexibility.'''.replace( '\n', ' ' ),
      ...
      '''White rhinos are superbly adapted to grazing and grassland survival. Their wide, prehensile lips and massive jaws allow them
         to harvest large amounts of grass efficiently. Thick skin provides protection against predators and environmental hazards,
         while deep folds help channel water and mud during wallowing. Horns are made of keratin and serve as defensive weapons,
         social signals, and tools for digging or clearing vegetation. Strong limbs and a heavy, muscular body support movement
         across uneven terrain, while acute hearing and smell compensate for relatively poor eyesight.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Spotted hyenas are highly specialized predators and scavengers. Their extremely strong jaws and digestive systems allow them
         to consume and extract nutrients from bones and other tough materials. Muscular forequarters and long stamina give them
         endurance for chasing prey over long distances. Their complex social cognition enables coordination during hunts and
   ...
   (
      ...
      '''The warthog habitat can be found in the Africa Savanna loop, in between the giraffes and hippos. The warthog is one of the
         more difficult species to see at the zoo--timing is everything. They can be most often be seen by looking directly down from
         their viewing. One of the warthogs at the zoo likes to rest right near the close fence of the enclosure. You have a better
         chance of seeing them active in the morning, or closer to dusk.'''.replace( '\n', ' ' ),
      '''Warthogs are very sensitive to the cold, and thus are only viewable outside during the warmest months, late May to September,
         and on other warm days.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      -5,                                                            # Minimum temperature (only for animals with outdoor viewing)
      2,                                                             # Snow resistance (only for animals with outdoor viewing)
      '''The watusi cattle habitat can be found near the part of the Africa Savanna where you access the Canadian Domain, across from
         the spotted heynas.'''.replace( '\n', ' ' ),
      ...
      '''Watusi cattle are among the most visually dramatic cattle breeds in the world, defined by their massive, lyre-shaped horns,
         which may span up to 2.4 meters (8 feet) and weigh over 45 kg combined. These horns sit atop a long, narrow head and a lean,
         tall body supported by long legs. Coat colouration varies widely, including deep red, chestnut, black, white, brindled, or
         speckled patterns. Adults typically weigh 450–730 kg, with bulls larger and heavier than cows.'''.replace( '\n', ' ' ),
      '''The breed originated in East Africa, particularly within Uganda, Rwanda, Burundi, and adjacent regions. For centuries, Watusi
         cattle were raised in open savanna, grassland, and semi-arid environments, often in areas with intense heat and seasonal
         water scarcity. Today, they are found globally in managed care, including zoological parks and conservation-focused breeding
         programs.'''.replace( '\n', ' ' ),
      ...
      '''The most remarkable adaptation of Watusi cattle lies in their horn physiology. Unlike solid horns, Watusi horns contain an
         extensive network of blood vessels, allowing heat to dissipate as blood circulates through the horn surface—functioning as a
         natural radiator system in hot climates. Their lean body shape, large skin surface area, and heat tolerance further reduce
         thermal stress. Additionally, they exhibit resilience to drought conditions and some resistance to regional parasites,
         reflecting long-term adaptation to challenging environments.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The white-breasted cormorant can handle temperate environments, and can thus be outside for most of the year, but cannot
         ...
         .replace( '\n', ' ' ),
      '''The white-breasted cormorant is a large, dark waterbird distinguished by its glossy black body, white throat and upper chest,
         and long, hooked bill. Adults measure 70–85 cm in length with a wingspan of up to 1.4 meters. During the breeding season,
         small white feather patches may appear on the head and neck. Males and females are similar in appearance, though males are
         typically slightly larger.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The zoo is home to one white-headed vulture, Lloyd, and he is one of the more reclusive residents. He resides in the
         enclosure with the kudu and other savanna birds. He may be spotted from any of the three viewing areas for this exhibit: the
         savanna outlook in the African Rainforest Pavilion near the meerkats, on the offshoot path between the hippos and rhinos, or
         at the main viewing across from the white rhinos, but you will have the best chance at the offshoot viewing followed by the
         main viewing area.'''.replace( '\n', ' ' ),
      ...
      '''The white-headed vulture is a medium-sized but powerfully built vulture with a distinctive appearance. Adults have a bright
         white head and neck, contrasting sharply with a dark brown to black body. The face often shows pink or reddish skin, and the
         wings display bold white patches visible in flight. Body length ranges from 72–85 cm, with a wingspan of up to 2.1 meters.
         Females are slightly larger than males.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The African clawed frog is a fully aquatic frog with a flattened body, smooth, slippery skin, and powerful hind legs. Its
         colouration ranges from olive-gray to brown, often mottled for camouflage. Unlike many frogs, it lacks a tongue and external
         eardrums. Each hind foot has three sharp, black claws, which give the species its common name. Adults typically measure
         5–13 cm in length, with females larger than males.'''.replace( '\n', ' ' ),
      '''This species is native to sub-Saharan Africa, where it inhabits slow-moving rivers, ponds, lakes, and flooded forest pools,
         including rainforest environments. African clawed frogs are highly adaptable and can survive in both permanent and temporary
         water bodies. Due to introductions, they now occur in parts of Europe, North America, and South America, where they are
         considered invasive.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The African spoonbills can be found in a mixed-species habitat, shared with the sacred ibis and South African shelduck, near
         the pygmy hippos, and softshell turtle.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The African spoonbill is a large white wading bird easily recognized by its long, flattened, spoon-shaped bill. Adults stand
         about 80–90 cm tall with a wingspan reaching 1.3 meters. The plumage is entirely white, contrasted by a pinkish face and
         legs. During the breeding season, adults develop a yellow patch on the chest. Males and females are similar in appearance.'''
         .replace( '\n', ' ' ),
      '''This species is widespread across sub-Saharan Africa and Madagascar, inhabiting shallow wetlands, floodplains, marshes, lake
         edges, and slow-moving rivers. Although not restricted to rainforests, African spoonbills frequently use forested wetlands
         and river systems within rainforest regions.'''.replace( '\n', ' ' ),
      '''African spoonbills feed primarily on small fish, aquatic insects, crustaceans, and mollusks. They forage by sweeping their
         bill side to side through shallow water, snapping it shut when prey is detected by touch. This feeding method allows them to
         hunt effectively even in muddy or low-visibility water.'''.replace( '\n', ' ' ),
      ...
      '''The species’ most notable adaptation is its sensitive, spoon-shaped bill, which enables tactile feeding without relying on
         sight. Long legs allow efficient wading through shallow wetlands, while broad wings provide energy-efficient soaring between
         feeding sites. Their white plumage may help reduce heat absorption in open, sunlit wetlands.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Though often perceived as solitary, Aldabra tortoises exhibit interesting social behaviours. Males occasionally engage in
         ...
         patterns are influenced by temperature: they forage and move in cooler morning and evening hours, resting in shaded areas or
         wallowing in mud during the heat of the day. Observing these behaviours in a zoo setting provides insight into the complex
         lives of slow-moving reptiles, which are often underestimated.'''.replace( '\n', ' ' ),
      ...
      '''Sexual maturity is reached slowly: females may not breed until 20–30 years, with males slightly older. Breeding is seasonal,
         influenced by rainfall and food availability. Females lay 9–25 eggs in shallow nests dug into sandy soil, with an incubation
         period of 8–10 months, during which temperature can influence the sex of the hatchlings. Juveniles are small and vulnerable,
         requiring protective behaviours such as hiding in vegetation. Slow growth, delayed maturity, and long lifespan allow Aldabra
         tortoises to maintain population stability over decades, even in variable environments. Lifespan in managed care can extend
         beyond 150 years, making them one of the longest-lived vertebrates on the planet.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Blake’s crake is a small, secretive waterbird, measuring approximately 18–20 cm in length. It has olive-brown upperparts,
         ...
         adapted for walking on soft substrates, and toes are unwebbed but broad, aiding in stability on mud and floating plants. Its
         plumage is subtle, but its bright bill and cautious movements make it distinctive once observed closely.'''
         .replace( '\n', ' ' ),
      ...
      '''Blake’s crake is primarily insectivorous and carnivorous, feeding on aquatic invertebrates, small crustaceans, insect
         larvae, and occasionally small fish or plant matter. It uses its long bill to probe mud and shallow water, detecting prey by
         touch and quick flicking movements. The bird is a patient forager, often moving slowly and carefully through dense
         vegetation, minimizing disturbance to its surroundings.'''.replace( '\n', ' ' ),
      '''This species is solitary and secretive, preferring to hide in dense reeds or submerged roots rather than openly swimming. It
         communicates through soft calls and occasional clucking sounds, primarily during breeding or territorial disputes. Blake’s
         crake is highly adapted to stealthy movement, often walking on floating vegetation or along muddy banks, and will dive into
         cover when threatened.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''These birds are generally solitary or seen in pairs, often performing spectacular aerial displays, including twisting,
         rolling dives during courtship, which give the species its name. Their calls are harsh, squawking sounds used to communicate
         territory or alarm. They are highly territorial around feeding and nesting sites, defending perches vigorously against
         intruders.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The grey-necked crowned cranes can be found in a shared habitat with the ring-tailed lemurs, just inside the entrance to the
         pavilion near the giraffes.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''These cranes are social and highly expressive, often observed in pairs or small flocks. They are renowned for their
         ...
         .replace( '\n', ' ' ),
      '''The grey-necked crowned crane exhibits several adaptations for wetland and open-habitat living. Its long legs and toes allow
         efficient walking on soft, marshy ground, while broad wings support both flight and display behaviours. The spiky golden
         crown is used for visual signaling during courtship, and its powerful bill is adapted for foraging a wide variety of foods,
         from small animals to tough seeds. Its ability to tolerate shallow water and move gracefully across wet terrain demonstrates
         a combination of structural, behavioural, and ecological adaptations.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Gaboon viper is a large, heavy-bodied snake with a broad, triangular head and striking geometric patterns that resemble
         ...
         colouration includes shades of brown, tan, gray, and purple, creating nearly perfect camouflage among rainforest leaf litter.
         The species is also known for having the longest fangs of any snake, up to 5 cm, which it uses to deliver potent venom.'''
         .replace( '\n', ' ' ),
      '''Gaboon vipers are found in West and Central African rainforests, secondary forests, and forested savannas. They prefer dense
         undergrowth, fallen logs, and areas with thick leaf litter, which allow them to remain hidden while ambushing prey. Although
         mostly terrestrial, they may occasionally climb low branches to access prey or bask in filtered sunlight.'''
         .replace( '\n', ' ' ),
      ...
      '''Gaboon vipers are solitary and sedentary, spending most of their time hidden beneath leaves or fallen logs. They rarely
         ...
         freezing behaviour, only striking if directly provoked. During the breeding season, males may encounter each other and engage
         in brief combat rituals to compete for females, but interactions are generally limited and non-lethal.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Hamerkops are found throughout sub-Saharan Africa, inhabiting wetlands, rivers, lakes, marshes, and flooded grasslands. They
         prefer shallow water with open areas for foraging and nearby trees or reeds for roosting and nesting. Though they can occur
         at forest edges, they are mostly associated with wetland ecosystems and are sensitive to changes in water availability.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''These cichlids are native to Lake Malawi in East Africa, one of the world’s largest and most biodiverse rift lakes. They
         occupy a wide range of habitats, from rocky shorelines and sandy bottoms to open water and vegetated areas. Many species are
         highly territorial, particularly around breeding sites, and depend on stable water conditions with abundant food resources.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The mantella frog can be found in a terrarium in an enclosure between the dwarf crocodiles and Lake Malawai display, and the
         gorillas.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''Mantella frogs are small, brightly coloured amphibians, typically measuring 2–3 cm in length. Their skin displays striking
         ...
         predators. They have slender bodies, long legs, and adhesive toe pads, which allow agile movement across leaf litter and low
         vegetation. Males and females are similar in appearance, though males are slightly smaller and may have vocal sacs used
      ...
      '''These frogs are native to humid forests and rainforest floors of Madagascar, inhabiting leaf litter, low vegetation, and
         ...
         .replace( '\n', ' ' ),
      '''Mantella frogs are insectivorous, feeding on ants, termites, small beetles, and other tiny invertebrates. They actively hunt
         on the forest floor, using their sticky tongues to capture prey. Their diet in the wild is closely linked to their toxicity,
         as they derive defensive alkaloids from consuming certain ants and arthropods. In captivity, they are fed a variety of small
         invertebrates to maintain health and colouration.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The ngege live in a tank in the Lake Malawi exhibit, located between the gorilla rainforest and the rest of the pavilion.'''
         .replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''The ngege is a small to medium-sized cichlid, typically measuring 12–20 cm in length. It has a slender, laterally compressed
         body with silvery scales and faint vertical bands. Males often develop slightly brighter colours during breeding, with subtle
         iridescence, while females are more muted. The species has a terminal mouth adapted for picking food from the substrate or
         water column.'''.replace( '\n', ' ' ),
      '''Ngege are native to Lake Victoria and surrounding rivers in East Africa. They inhabit shallow coastal areas, rocky
         ...
         .replace( '\n', ' ' ),
      '''The ngege is omnivorous, feeding on algae, small invertebrates, and detritus. They often graze on submerged surfaces or pick
         invertebrates from plants and rocks. Their feeding behaviour helps control algae growth and maintain ecological balance in
         freshwater habitats. In captivity, diets include flake foods, algae wafers, and live or frozen invertebrates.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Nile soft-shelled turtle is a large freshwater turtle, with adults reaching 60–90 cm in carapace length and weighing
         30–50 kg. Unlike hard-shelled turtles, its carapace is leathery and flexible, brown to olive in colour, with small ridges and
         scattered dark spots. It has a long, tubular snout with nostrils at the tip, allowing it to breathe while mostly submerged.
         Limbs are broad and webbed, with strong claws for digging and grasping prey.'''.replace( '\n', ' ' ),
      ...
      '''Generally solitary, these turtles spend most of their time submerged or partially buried, conserving energy and avoiding
         ...
         may retreat to deeper water or use their flexible shell and burrowing ability to hide. During mating, males may become more
         active and display courtship behaviour by nudging or circling females.'''.replace( '\n', ' ' ),
      '''The Nile soft-shelled turtle exhibits several adaptations for aquatic ambush predation. Its leathery carapace and flattened
         body allow streamlined movement and partial burial in sand. The long tubular snout enables stealthy breathing at the water’s
         surface. Powerful, webbed limbs aid in swimming and sudden lunges to capture prey. Its sensory adaptations, including keen
         sight and vibration detection, allow it to locate prey while remaining largely concealed.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The pygmy hippopotamus is a compact, semi-aquatic mammal, typically measuring 1.5–1.75 meters in length and weighing
         ...
         “sunscreen” to protect against dehydration and infection. Unlike the common hippopotamus, the pygmy hippo has proportionally
         smaller, rounded eyes and ears, positioned higher on the head for underwater vision while keeping most of the body
         submerged. Its limbs are short and sturdy, supporting movement on soft forest floors and in shallow streams.'''
         .replace( '\n', ' ' ),
      '''Pygmy hippos are native to the dense forests and swamps of West Africa, particularly Liberia, Sierra Leone, Guinea, and
         ...
         feeding, thermoregulation, and safety needs. Unlike their larger relatives, pygmy hippos are more forest-adapted, relying on
         cover and shade rather than open waters.'''.replace( '\n', ' ' ),
      '''Pygmy hippos are herbivorous, feeding mainly at night. Their diet consists of leaves, ferns, fruits, grasses, and aquatic
         vegetation, which they forage in forested areas near water. They may also feed on fallen fruits in swampy areas. Foraging is
         largely solitary, and their digestive system is adapted to ferment and extract nutrients from fibrous plant material.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The radiated tortoise is a medium-sized land tortoise, typically measuring 35–45 cm in length and weighing 8–14 kg, with some
         individuals reaching over 20 kg. Its high-domed shell is dark brown or black with striking yellow or orange star-like
      ...
      '''The radiated tortoise’s high-domed, star-patterned shell provides protection from predators and camouflage among sun-dappled
         forest floors. Its strong, clawed limbs allow it to traverse rocky and sandy terrain, while its digestive system extracts
         nutrients efficiently from tough, fibrous plants. Its ability to store water and survive periods of drought is a key
         adaptation for Madagascar’s dry seasons. These adaptations make it highly specialized for survival in arid and semi-arid
         environments.'''.replace( '\n', ' ' ),
      '''Breeding occurs seasonally, with females laying 5–15 eggs per clutch in shallow burrows. Incubation lasts approximately 8–10
         months, with temperature influencing sex ratios. Hatchlings are small but independent, relying on camouflage and instinct
         for survival. Radiated tortoises are long-lived, with wild individuals reaching 40–50 years, and some in managed care living
         over 60 years.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Red River Hog',
      ...
      '''Red river hogs are medium-sized wild pigs, measuring 90–130 cm in body length and weighing 45–115 kg, with males typically
         larger than females. They are instantly recognizable by their rich reddish-brown fur, black legs, white facial markings, and
         large, tufted ears. Both sexes have prominent tusks, though those of males are longer and more curved, used for defense and
         foraging. Their elongated snouts are highly sensitive, equipped with tactile receptors to locate food underground. Piglets
         are born with striped coats that provide camouflage among forest leaf litter.'''.replace( '\n', ' ' ),
      ...
      '''These hogs are omnivorous opportunists, with diets including roots, tubers, fruits, fungi, insects, small mammals,
         ...
         forage at night in areas with human disturbance. Their foraging also contributes to seed dispersal and soil aeration, making
         them important ecosystem engineers.'''.replace( '\n', ' ' ),
      '''Red river hogs are highly social animals, living in sounders of 6–20 individuals, usually comprised of females and their
         ...
         .replace( '\n', ' ' ),
      '''Red river hogs are highly adapted to their forested and wetland habitats. Their reddish fur provides camouflage, while black
         legs and white facial markings may facilitate visual communication within dense vegetation. Tusks and strong jaws are used
         both for rooting and for defending against predators. Their long, mobile snouts allow precise foraging underground, while
         large, sensitive ears detect distant sounds. Wallows in mud help regulate body temperature, reduce parasite load, and
         provide skin protection. Omnivorous flexibility and territorial intelligence allow them to survive in dynamic, predator-rich
         rainforest environments.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The ring-tailed lemurs can be seen in a mixed-species habitat with the crowned cranes and Aldabra tortoise near the entrance
         to the pavilion near the giraffes.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''Ring-tailed lemurs are native to southern and southwestern Madagascar, inhabiting dry forests, spiny bush areas, gallery
         forests, and scrublands. Unlike many lemurs that live primarily in dense forests, ring-tailed lemurs often spend time on the
         ground and in open areas, foraging and sunbathing. They rely on trees for sleeping, safety, and food, but are highly
      ...
      '''These lemurs are omnivorous, feeding primarily on fruit, leaves, flowers, bark, and sap, supplemented occasionally with
         ...
         significant time foraging in groups, using their keen sense of smell to locate ripe fruit and edible plant parts. In managed
         care, diets are supplemented with a variety of fruits, vegetables, leafy greens, and specialized primate pellets to meet
         nutritional needs.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Royal pythons are native to West and Central Africa, inhabiting grasslands, savannas, open forests, and agricultural areas.
         They spend much of their time underground or in burrows, using abandoned mammal dens, termite mounds, or natural crevices to
         hide during the day and avoid predators. They prefer humid microclimates but are adaptable to a range of conditions within
         their range.'''.replace( '\n', ' ' ),
      ...
      '''Royal pythons have evolved numerous adaptations for ambush predation. Heat-sensitive pits allow detection of warm-blooded
         ...
         swallowing animals larger than their head diameter. Cryptic colouration provides camouflage in leaf litter and burrows, while
         their coiling defense behaviour reduces predation risk. Burrowing and nocturnal activity also help them avoid predators and
         harsh daytime conditions.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Breeding occurs in seasonal colonies, often during the rainy season. Females lay 2–5 eggs in nests made of sticks, reeds,
         ...
         hatching blind and featherless, but fledge in about 35–45 days. Sacred ibises can live 10–15 years in the wild, and slightly
         longer in managed care.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      '''Slender-tailed meerkats are highly social, living in cohesive groups called mobs or clans, typically containing 10–30
         individuals, but sometimes larger. Groups are organized with a dominant breeding pair, while other members serve as helpers,
         foraging, babysitting, and maintaining vigilance. Meerkats are diurnal, and sentinel behaviour is a hallmark: one individual
         stands guard on a mound, scanning for predators while others forage. Vocalizations include alarm calls, social chirps, and
         contact calls, coordinating group activities and signaling threats. Play, grooming, and cooperative care strengthen social
         bonds and teach young essential survival skills.'''.replace( '\n', ' ' ),
      '''Meerkats exhibit adaptations for desert and semi-arid life. Their slender bodies and light fur help regulate body
         ...
         burrow systems, which provide protection and temperature control. Their cooperative social structure enhances survival, with
         sentinels detecting predators and helpers ensuring food distribution and pup care. They also have resistance to certain
         venoms, allowing them to prey on scorpions safely.'''.replace( '\n', ' ' ),
      '''Breeding is typically dominated by the alpha pair, though subordinate females may occasionally reproduce. Gestation lasts
         ...
         under the care of helpers. They emerge at 3–4 weeks, gradually learning to forage and participate in sentinel duties. Sexual
         maturity is reached around 12 months, and lifespan in the wild is usually 6–8 years, while in managed care they may live up
         to 12–14 years.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
   ...
   (
      ...
      '''Speckled mousebirds are small to medium-sized birds, measuring 25–30 cm in length, with a long, thin tail that accounts for
         ...
         appearance. They have a small, rounded head with a short crest, and dark eyes with a short, slightly curved bill adapted for
         feeding on fruit and foliage. Their legs are strong, allowing them to climb and scurry along branches in a mouse-like
      ...
      '''Speckled mousebirds are native to sub-Saharan Africa, including countries such as South Africa, Botswana, Zimbabwe, and
         Kenya. They inhabit savannas, woodland edges, gardens, and scrublands, often near fruiting trees and shrubs. They are highly
         arboreal but will move on the ground or between branches when foraging.'''.replace( '\n', ' ' ),
      ...
      '''Speckled mousebirds are highly social, usually found in small flocks of 6–20 individuals. They are active and agile, using
         ...
         communicating with soft chirps and whistles. Social behaviours include mutual preening, huddling for warmth, and cooperative
         alertness against predators.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Spider tortoises are endemic to southwestern Madagascar, primarily inhabiting spiny forests and scrublands with sandy,
         well-drained soils. They prefer areas with dense leaf litter and scattered shrubs, which provide cover and microhabitats for
         foraging and shelter. Seasonal rainfall heavily influences their activity patterns, as the species relies on moisture for
         feeding and reproduction.'''.replace( '\n', ' ' ),
      '''These tortoises are herbivorous, feeding on succulent plants, leaves, fruits, and flowers. They forage primarily during the
         wet season, when plant material is more abundant, and may burrow or hide during the dry season to conserve water. Their diet
         contributes to seed dispersal and vegetation management in their native ecosystems. In zoos, they are fed a diet of leafy
         greens, vegetables, and occasional fruits, carefully balanced to mimic natural nutrition.'''.replace( '\n', ' ' ),
      ...
      '''Spider tortoises have several adaptations for survival in arid, spiny forests. Their high-domed, radiated shell provides
         ...
         shelter or food, and their ability to conserve water and remain inactive during dry periods helps them endure harsh seasonal
         conditions. Their herbivorous diet and selective feeding on moisture-rich plants optimize water and nutrient intake in their
         environment.'''.replace( '\n', ' ' ),
      '''Breeding typically occurs during the wet season, when females lay 1–3 small, hard-shelled eggs in shallow nests dug into
         ...
         face high predation and environmental risks. Sexual maturity is reached around 5–7 years, and lifespans can exceed 50 years
         in captivity, though wild individuals often have shorter lifespans due to predation and habitat pressures.'''
         .replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      ...
      '''These bats are native to sub-Saharan Africa, ranging from Senegal to Ethiopia and south to South Africa. They inhabit
         ...
         Straw-coloured fruit bats are highly mobile, undertaking seasonal migrations of hundreds of kilometers in search of fruiting
         trees.'''.replace( '\n', ' ' ),
      ...
      '''Straw-coloured fruit bats are highly social, forming colonies of thousands to millions in roosting trees. Social hierarchies
         are subtle, with large numbers offering safety in numbers against predators such as owls, snakes, and humans. They are
         nocturnal, resting during the day in shaded trees and emerging at dusk to feed. Colonies are noisy, filled with squawks,
         chatter, and wing-flapping, which also aids in group cohesion and territorial spacing.'''.replace( '\n', ' ' ),
      ...
      '''Breeding is seasonally synchronized, typically coinciding with periods of abundant fruit availability. Females give birth to
         a single pup after a gestation of about 5–6 months. Pups cling to their mothers for the first few weeks and are gradually
         weaned after 2–3 months. Sexual maturity is reached at 1–2 years, and in captivity, they can live 15–20 years, while
         lifespans in the wild are slightly shorter due to predation and migration challenges.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Tomato Frog',
      ...
      '''The tomato frog can be found in a terrarium in an enclosure between the dwarf crocodiles and Lake Malawai display, and the
         gorillas.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''Tomato frogs are medium-sized amphibians, with females larger than males, measuring 6–10 cm in length. Their most distinctive
         feature is their bright red to orange-red colouration, which serves as a warning to predators. Males are smaller and slightly
         duller. They have rounded bodies, short limbs, and large, protruding eyes, giving them a robust, squat appearance. The skin
         is smooth and slightly sticky, with mucus glands that can secrete a mild toxin when threatened.'''.replace( '\n', ' ' ),
      ...
      '''These frogs are carnivorous, feeding on insects, worms, and other small invertebrates. They use a sit-and-wait hunting
         strategy, remaining partially buried or hidden among leaves and striking prey with their sticky tongues. In captivity, their
         diet is typically supplemented with crickets, mealworms, and other appropriately sized invertebrates.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Veiled chameleons are largely solitary, interacting primarily during the breeding season. They exhibit territorial
         behaviours, with males displaying bright colours, head bobbing, and swaying to intimidate rivals or attract females. Despite
         their solitary nature, they are highly alert and visually oriented, constantly scanning the environment for prey and
         predators. Movement is slow and deliberate, using hand-over-hand climbing and tail-assisted balance.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Violaceous plantain-eaters are primarily frugivorous, feeding on figs, plantains, papayas, and other soft fruits, though
         ...
         beaks to pluck and manipulate fruit, swallowing it whole. Their feeding behaviour plays a significant role in seed dispersal,
         helping to maintain healthy forest ecosystems.'''.replace( '\n', ' ' ),
      ...
      '''Violaceous plantain-eaters have several adaptations for arboreal life and frugivory. Their strong, slightly curved beak
         ...
         colouration provides camouflage among canopy foliage. Their role as seed dispersers is a key ecological adaptation, allowing
         them to influence forest regeneration.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''West African dwarf crocodiles are the smallest of African crocodiles, with adults typically 1.2–1.5 meters in length and
         ...
         colouration is generally dark brown to olive, providing camouflage in forested waterways. Their eyes are positioned dorsally,
         allowing them to see while mostly submerged, and their powerful jaws are adapted for crushing prey.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Toronto Zoo houses two groups of gorillas which go on display separately--the family troop, containing the females, and
         ...
         outside, and the other group, usually the males, inside. If it is too cold for the gorillas to be outside, then you will find
         one group in the main indoor habitat, and the other in the day room across from the main habitat.'''.replace( '\n', ' ' ),
      ...
      '''Western lowland gorillas are the smallest of the gorilla subspecies, yet still powerful. Adult males reach 140–180 cm in
         ...
         thumbs and big toes, allowing precise manipulation of objects and efficient climbing. Juveniles and subadults are darker and
         smaller, and their facial expressions are often highly animated, signaling curiosity, fear, or playfulness.'''
         .replace( '\n', ' ' ),
      '''These gorillas inhabit dense tropical rainforests of central Africa, including Cameroon, the Central African Republic,
         Equatorial Guinea, Gabon, and the Republic of Congo. They prefer lowland swamp forests, secondary forests, and areas rich in
         fruiting trees, sometimes venturing into upland forests when food is available. Home ranges are typically 5–20 km², and
         gorillas move daily to forage efficiently while avoiding humans and predators. Their choice of habitat is influenced by food
         availability, water sources, and forest structure, as they require thick understory for protection and canopy cover for
         nesting sites. Seasonal changes affect their movement patterns, with wet seasons encouraging expansion into flooded areas
         rich in fruit, while dry seasons may concentrate them near reliable water sources.'''.replace( '\n', ' ' ),
      '''Western lowland gorillas are primarily herbivorous, feeding on leaves, stems, shoots, fruits, seeds, and flowers, and
         occasionally small invertebrates like ants or termites. They are selective feeders, often stripping leaves, peeling bark, or
         choosing specific fruit ripeness. Fruit availability strongly influences daily movements, group cohesion, and social
      ...
      '''Western lowland gorillas have numerous adaptations for forest survival and social life. Powerful arms and hands enable
         ...
         using sticks to measure water depth, leaves as drinking tools, or branches for play and enrichment. Social cohesion, learned
         behaviours, and complex communication are critical adaptations for living in dense, competitive rainforest environments.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''Asian brown tortoises are large, terrestrial tortoises, with adults measuring 50–70 cm in length and weighing 20–40 kg.
         ...
         cream-coloured. The head is relatively small with strong, beak-like jaws for cutting vegetation. Their thick, scaly legs are
         equipped with stout claws for digging and navigating uneven forest floors.'''.replace( '\n', ' ' ),
      ...
      '''Adaptations for terrestrial forest life include a domed, strong shell for protection, clawed feet for digging, and the
         ability to digest fibrous plant material efficiently. Their colouration allows camouflage on the forest floor, and their slow
         metabolism supports long periods of limited food availability.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Native to eastern Asia, including China and Siberia, bighead carp inhabit slow-moving rivers, lakes, and reservoirs. They
         prefer warm, eutrophic waters with abundant plankton. In many regions outside their native range, they have become invasive,
         affecting local ecosystems by outcompeting native fish for food.'''.replace( '\n', ' ' ),
      '''Bighead carp are filter feeders, consuming phytoplankton, zooplankton, and suspended organic matter. They swim with open
         ...
         This feeding behaviour can significantly alter the composition of aquatic ecosystems, reducing plankton available for native
         species. In zoos or aquaria, they are fed plankton substitutes, commercially prepared diets, or finely ground greens to
         mimic natural feeding habits.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The black carp can be found in the carp tank just past the waterfall, found by taking the path on the left once you enter
         ...
         slightly by going to the left.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      '''Black carp are large freshwater fish, typically reaching 60–100 cm in length, with some individuals exceeding 1.2 meters and
         weighing over 20 kg. They have a long, cylindrical body with a dark, bluish-black to gray colouration and a broad, flattened
         head. Their jaws are strong, and their teeth are molariform, specialized for crushing mollusk shells, giving them a
         distinctive feeding adaptation.'''.replace( '\n', ' ' ),
      ...
      '''Black carp have several adaptations for their specialized diet and freshwater habitat. Their molars crush hard-shelled prey,
         while strong jaws and a broad head facilitate feeding on mollusks. Streamlined bodies allow them to navigate rivers and
         ponds efficiently, and their dark colouration provides camouflage on the bottom of silty or vegetated waters. They are also
         long-lived and slow-growing, which supports survival in variable freshwater environments.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Black-breasted leaf turtles are omnivorous, feeding on fallen fruits, fungi, leaves, and small invertebrates. They are
         slow-moving foragers, using their keen sense of smell to locate food among leaf litter. In captivity, they are provided with
         a varied diet of fruits, vegetables, worms, and specially formulated turtle food, encouraging natural feeding behaviour and
         proper nutrition.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Burmese star tortoise is a medium-sized terrestrial tortoise, measuring 20–25 cm in length and weighing 2–3 kg. Its
         ...
         star, which gives the species its name. The plastron is light-coloured with dark markings, and the head and limbs are scaled,
         with stout claws for digging. Juveniles display more vibrant star patterns, which fade slightly with age.'''
         .replace( '\n', ' ' ),
      '''This species is native to dry and scrubby regions of central Myanmar, inhabiting thorn forests, grasslands, and seasonal dry
         forests. It prefers areas with sandy or loamy soil, which allows for burrowing and nesting. Burmese star tortoises rely on
         leaf litter and low vegetation for cover, and seasonal rains influence their activity patterns and foraging behaviour.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      '''This species is highly social, often seen feeding in loose groups and roosting communally. Cattle egrets are strong fliers
         and migrate or disperse widely, which has contributed to their remarkable global spread. They are most active during the day
         and frequently shift feeding locations depending on the movement of grazing animals. Breeding occurs in large mixed-species
         colonies, often in trees near wetlands.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Concave casqued hornbills are primarily frugivorous, feeding on a wide variety of forest fruits, especially figs. They also
         ...
         increase. Their feeding behaviour involves swallowing fruits whole and later regurgitating or passing seeds, making them key
         seed dispersers in rainforest ecosystems. In zoos, they are provided with mixed fruits, vegetables, insects, and formulated
         diets to replicate this balance.'''.replace( '\n', ' ' ),
      ...
      '''Breeding behaviour is one of the most remarkable among birds. The female seals herself inside a tree cavity nest using mud,
         fruit pulp, and droppings, leaving only a narrow slit. She remains inside for the entire incubation and early chick-rearing
         period, relying completely on the male to deliver food. Females lay 1–2 eggs, with incubation lasting about 30 days. Chicks
         remain in the cavity for several months before fledging. Concave casqued hornbills can live 30–40 years, especially in
   ...
   (
      ...
      '''These birds are typically seen alone, in pairs, or in small family groups. They are shy and secretive, relying on camouflage
         and stillness rather than flight when threatened. When startled, they may burst into short, rapid flight to escape into
         dense cover. Vocalizations are soft but distinctive and are used to maintain contact between mates in thick vegetation.'''
         .replace( '\n', ' ' ),
   ...
   (
      ...
      None,                                                          # Seasonal viewing tips
      '''The crocodile lizard is a medium-sized, heavily armored-looking reptile, reaching 40–45 cm in total length, much of which is
         tail. Its name comes from the large, keeled scales along the tail, which resemble those of a crocodile. The body is
         ...
         edges.'''.replace( '\n', ' ' ),
      '''This species has a very restricted natural range, occurring in southern China and northern Vietnam. It inhabits cool, shaded
         forest streams, where clean, slow-moving water flows through dense vegetation. Crocodile lizards are highly dependent on
         intact riparian forests, making them especially vulnerable to habitat loss, water pollution, and climate change.'''
         .replace( '\n', ' ' ),
      '''Crocodile lizards are carnivorous, feeding primarily on insects, spiders, small fish, tadpoles, and other small vertebrates.
         They hunt using a sit-and-wait strategy, remaining motionless along stream banks or partially submerged before striking
         quickly at passing prey. In zoos, they are fed a carefully balanced diet of insects and small aquatic prey, adjusted to
         match their low metabolism.'''.replace( '\n', ' ' ),
      '''These lizards are slow-moving, secretive, and largely solitary. They spend much of their time resting on branches or rocks
         overhanging water and will drop into the stream to escape predators. Crocodile lizards are most active during cooler parts of
         the day and are unusually tolerant of lower temperatures compared to many reptiles, reflecting their montane forest habitat.'''
         .replace( '\n', ' ' ),
      '''The crocodile lizard’s armored tail scales provide protection and may help deter predators. Its semi-aquatic lifestyle is
         ...
         seamlessly into mossy rocks and shaded stream banks. Unlike many reptiles, it is adapted to cool, humid environments, with a
         physiology that functions efficiently at lower temperatures.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''Breeding occurs in water, where females lay strings or clusters of eggs attached to submerged vegetation. Eggs hatch into
         ...
         several years. In the wild, crocodile newts likely live 10–15 years, while individuals in managed care can reach 20 years or
         more under optimal conditions.'''.replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
      'Edward\'s Pheasant',
      None,                                                          # Minimum temperature (only for animals with outdoor viewing)
      None,                                                          # Snow resistance (only for animals with outdoor viewing)
      '''The Edward's pheasant can be found in the main aviary in the Indo-Malaya pavilion, which sits in the center of the pavilion.
         The best area to view the birds in the aviary is in between the stairs leading down from the elevated orangutan viewing, up
         until you are across from the doors leading you to the outdoor orangutan habitat.'''.replace( '\n', ' ' ),
      None,                                                          # Seasonal viewing tips
      ...
      '''Edward’s pheasants are omnivorous, feeding on seeds, fruits, shoots, insects, and other small invertebrates. They forage by
         slowly walking along the forest floor, using their bills and feet to uncover food beneath leaf litter. In zoo care, they are
         offered a balanced diet of grains, fruits, greens, and protein sources to replicate their natural feeding habits.'''
         .replace( '\n', ' ' ),
      '''These birds are shy and secretive, usually seen alone or in pairs. They rely on stillness and dense cover rather than flight
         to avoid predators. Edward’s pheasants are most active during the early morning and late afternoon, when they forage quietly
         along forest edges and understory paths.'''.replace( '\n', ' ' ),
      '''Edward’s pheasant’s cryptic colouration—especially in females—provides camouflage against the forest floor. Strong legs and a
         sturdy body allow efficient ground movement through dense vegetation. The male’s glossy plumage plays a role in courtship
   ...
   ( # Also in Malayan Woods Pavilion
      ...
      '''These fish are generally slow-moving and calm, though large adults can become territorial, especially during breeding. Giant
         gouramis are intelligent by fish standards and often recognize regular caretakers. They spend much of their time cruising
         slowly through the water column or resting near structures.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The Malaysian painted turtle shows several adaptations to large river and estuarine environments. Its streamlined shell aids
         efficient swimming, while powerful limbs support movement in currents. Seasonal colour changes in males function in courtship
         and mate recognition, and tolerance for brackish water allows access to productive coastal habitats. Long-distance movements
         along river systems help locate nesting and feeding sites.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The spiny turtle’s spiked carapace provides defense against predators, while its muted colouration aids in camouflage on the
         forest floor. Its short, sturdy limbs and webbed feet allow efficient movement through leaf litter and shallow water, and
         its omnivorous diet ensures flexibility in changing seasonal food availability. The spiny ridges may also deter predation
         by making the turtle difficult to swallow. Overall, the species is highly adapted to a humid, forested, riparian
   ...
   (
      ...
      '''The Sumatran orangutans have an indoor and outdoor habitat in the Indo-Malaya Pavilion. Their indoor habitat can be viewed
         ...
         orangutans are not a highly social species like most other apes and primates. In each of the habitats you will only ever see
         one or two orangutans on exhibit at a time.'''.replace( '\n', ' ' ),
   ...
   (
      ...
      '''The tri-coloured shark is a medium-sized freshwater fish, typically reaching 20–25 cm in length. Its body is sleek and
         ...
         Juveniles are smaller and often exhibit more subtle colouration, which intensifies as they mature. Their streamlined body is
         well-suited for swimming in fast-flowing waters.'''.replace( '\n', ' ' ),
      ...
      '''Tri-coloured sharks spawn in response to rainy season floods, scattering eggs over submerged vegetation or substrates. There
         is no parental care, and juveniles are independent immediately. Growth is moderate, with sexual maturity reached at 1–2
         years, and individuals can live 6–10 years in the wild, with similar or slightly longer lifespans in captivity.'''
         .replace( '\n', ' ' ),
      None                                                           # Animals at the zoo
   ),
   (
   ...
   (
      ...
      '''The babirusa has an outdoor and indoor habitat. The outdoor habitat can be found outside the greater one-horned rhinoceros
         building and on the left. If you don't see the babirusa outside, check inside the Indian rhino building. The babirusa shares
         this space with the rhino, and is sometimes viewable inside.'''.replace( '\n', ' ' ),
