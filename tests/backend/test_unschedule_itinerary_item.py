...
def test_unschedule_itinerary_animal_clears_times_but_keeps_row(
   ...
   assert ItineraryController.schedule_itinerary_item( 'animals', ANIMAL_KEY ).success
   ...
   assert ItineraryController.unschedule_itinerary_item( 'animals', ANIMAL_KEY ).success
...
def test_unschedule_itinerary_attraction_clears_times(
   ...
   assert ItineraryController.unschedule_itinerary_item(
      'attractions',
      CAROUSEL ).success
...
def test_unschedule_itinerary_event_deletes_row( db: DbControllers ) -> None:
   ...
   assert ItineraryController.unschedule_itinerary_item( 'lunch', '' ).success
